...
**وضعیت:** ✅ **قابل استفاده با نگه‌داری bot_id به عنوان tenant_id**

**تحلیل جدید:**

اگر `bot_id` را همان `tenant_id` نگه داریم، **85-90% کد قابل استفاده است**.
...
1. ✅ **نگه‌داری bot_id به عنوان tenant_id**
...
**نکته:** اگر `bot_id` را همان `tenant_id` نگه داریم، 85-90% کد قابل استفاده است.
