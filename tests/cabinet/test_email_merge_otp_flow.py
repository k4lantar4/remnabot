...
def _email_auth_enabled(monkeypatch):
    """The email-login gate reads its flag row first; the stub db here returns one result for
    any execute, so decide the flag directly: enabled, no row (as upstream 23a58172 does)."""
