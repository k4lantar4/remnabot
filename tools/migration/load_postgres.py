...
from app.database.crud.subscription import create_subscription_no_commit, get_subscription_by_user_and_tariff
...
async def load_migration_data(
    ...
    *,
    ...
    for i, sub in enumerate(subscribers):
        ...
        existing_sub = await get_subscription_by_user_and_tariff(db, user.id, sub.tariff_id)
