...
from tools.migration.config import MIGRATION_BACKUPS_ROOT, ROOKARI_DB_PATH, XUI_BACKUP_DIR
...
def create_backup(
    *,
    ...
    xui_backup: Path = XUI_BACKUP_DIR,
    dest: Path | None = None,
    ...
    if xui_backup.is_dir():
        shutil.copytree(xui_backup, dest / 'xui_bcp', dirs_exist_ok=True)
