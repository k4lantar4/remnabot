...
def upgrade() -> None:
    ...
    op.execute("UPDATE promo_groups SET auto_assign_total_spent_toman = auto_assign_total_spent_toman * 100 WHERE auto_assign_total_spent_toman IS NOT NULL")
    ...
    op.execute("ALTER TABLE subscription_conversions RENAME COLUMN first_payment_amount_kopeks TO first_payment_amount_toman")
    op.execute("UPDATE subscription_conversions SET first_payment_amount_toman = first_payment_amount_toman * 100 WHERE first_payment_amount_toman IS NOT NULL")
    ...
    op.execute("ALTER TABLE advertising_campaign_registrations RENAME COLUMN balance_bonus_kopeks TO balance_bonus_toman")
...
def downgrade() -> None:
    ...
    # advertising_campaign_registrations table
    op.execute("ALTER TABLE advertising_campaign_registrations RENAME COLUMN balance_bonus_toman TO balance_bonus_kopeks")
    ...
    # subscription_conversions table
    op.execute("ALTER TABLE subscription_conversions RENAME COLUMN first_payment_amount_toman TO first_payment_amount_kopeks")
    op.execute("UPDATE subscription_conversions SET first_payment_amount_kopeks = first_payment_amount_kopeks / 100 WHERE first_payment_amount_kopeks IS NOT NULL")
    ...
    op.execute("UPDATE promo_groups SET auto_assign_total_spent_kopeks = auto_assign_total_spent_kopeks / 100 WHERE auto_assign_total_spent_kopeks IS NOT NULL")
