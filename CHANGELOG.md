...
## [3.61.0](https://github.com/k4lantar4/remnabot/compare/v3.60.0...v3.61.0) (2026-06-13)


### New Features

* **bot:** show legacy panel username in my subscriptions list ([76f1d13](https://github.com/k4lantar4/remnabot/commit/76f1d13abdc53727653a4a8b8ac65ecabfec5499))
* **bot:** use legacy panel username in tariff cart label ([e428002](https://github.com/k4lantar4/remnabot/commit/e428002b8d63baba2ccef9309b668447d5ccadb6))
* **c2c:** /start topup_c2c deep link ([e716f68](https://github.com/k4lantar4/remnabot/commit/e716f68f74a3dd047b33d2b43cf1da162c8965c7))
* **c2c:** add C2C env settings and document in .env.example ([0ba7f46](https://github.com/k4lantar4/remnabot/commit/0ba7f46af9a28f17507c4f617e7b1ce40e2ab2fe))
* **c2c:** add c2c_receipts table and PaymentMethod.C2C ([8635e59](https://github.com/k4lantar4/remnabot/commit/8635e591e33d8821f9a99407efa74bc358a3c1a5))
* **c2c:** add standalone card-to-card payment plugin ([75a135a](https://github.com/k4lantar4/remnabot/commit/75a135a4f2143c8081f0b0c5dd2e96238435a7a1))
* **c2c:** register in PaymentMethodConfig service ([f614229](https://github.com/k4lantar4/remnabot/commit/f614229b35ff77d15f8870a2c54b331e61657208))
* **c2c:** schema and configuration ([43b96bf](https://github.com/k4lantar4/remnabot/commit/43b96bfbba79acd61609e839c09e56b9d9c67f47))
* **c2c:** wire C2C into balance menu and bot bootstrap ([1321d3c](https://github.com/k4lantar4/remnabot/commit/1321d3c9f21cdfa9474650564631d360c957eea0))
* **cabinet:** C2C bot deeplink in balance API and UI ([aecf316](https://github.com/k4lantar4/remnabot/commit/aecf31651eef7338e14eb05a42d67e3c178f223b))
* **cabinet:** expose panel_username in subscriptions API ([9a61d93](https://github.com/k4lantar4/remnabot/commit/9a61d93ae8f5ce5d7133341b7daa61d7b037fc31))
* **cabinet:** show legacy panel username in subscription list ([3e36755](https://github.com/k4lantar4/remnabot/commit/3e3675539ddeccc460dac47b3100d891f2cf91d8))
* **cabinet:** subscription display label and search filter util ([574ee8e](https://github.com/k4lantar4/remnabot/commit/574ee8e3ef264d26efbf73443f92dbec0c1661dd))
* **cabinet:** subscription list search on Subscriptions page ([6989907](https://github.com/k4lantar4/remnabot/commit/69899076fb1cadfd9f8f6a2e98c4aa1aa621899c))
* **currency:** catalog_price_in_toman at purchase boundaries ([cb82e72](https://github.com/k4lantar4/remnabot/commit/cb82e72bfa58cb2165c2362d48063b9fd897c52d))
* **currency:** Phase B balance stored as Toman 1:1 ([c698dcb](https://github.com/k4lantar4/remnabot/commit/c698dcb411dbf120b30531b337f0bb01a5dedd6b))
* **dates:** add format_user_datetime helper for fa Jalali calendar ([82c8cb3](https://github.com/k4lantar4/remnabot/commit/82c8cb3ba12c23a5cc09833996bb41e72783b554))
* **dates:** add formatUserDate helper with Jalali calendar for fa ([5a56400](https://github.com/k4lantar4/remnabot/commit/5a56400cd18b69e8b48f3c40568a4c40b8aa6adc))
* **dates:** Jalali dates across remaining cabinet user pages for fa ([4f3a7da](https://github.com/k4lantar4/remnabot/commit/4f3a7da0127e959cce6aed0bd8d3e9f8276b04e0))
* **dates:** Jalali dates in cabinet purchase API and miniapp for fa ([b8ca5a4](https://github.com/k4lantar4/remnabot/commit/b8ca5a4c69f250653f93269dbac78b1638fda304))
* **dates:** Jalali dates in my_subscriptions for fa users ([86900d3](https://github.com/k4lantar4/remnabot/commit/86900d3de58d3d47acde33ba4305df035ca182f2))
* **dates:** Jalali dates in purchase handler for fa users ([ea8c216](https://github.com/k4lantar4/remnabot/commit/ea8c216cbf68b09d243eb73fd68b3457ad3555fc))
* **dates:** Jalali dates in simple_subscription for fa users ([9d62702](https://github.com/k4lantar4/remnabot/commit/9d62702be8fcf6a71702ccdf727813e0370b21f0))
* **dates:** Jalali subscription dates in cabinet user pages for fa ([9923758](https://github.com/k4lantar4/remnabot/commit/99237580a0a1e26909110d003a74da91951e231b))
* **dates:** show Jalali expiry in menu subscription status for fa ([0ca65f9](https://github.com/k4lantar4/remnabot/commit/0ca65f9d873f2f5bc61e6906d211c5165ee1ab44))
* **dates:** show Jalali expiry in start subscription status for fa ([bc803ea](https://github.com/k4lantar4/remnabot/commit/bc803eab2e7a87b1954e72c3dfff9f43f9540dd8))
* **db:** allow multiple active subs per tariff via account_sequence ([fb128ad](https://github.com/k4lantar4/remnabot/commit/fb128adbf00594d925e1205a71ee30b1cf92ec5a))
* **display:** add x-ui legacy panel username matcher ([428f9b6](https://github.com/k4lantar4/remnabot/commit/428f9b638def7a912c1f2cab8bdcb214dcacd8f3))
* **display:** restore legacy x-ui subscription names from backup ([9c50999](https://github.com/k4lantar4/remnabot/commit/9c5099950a66e25df2754c557fffe8d123c33ee1))
* **gift:** unify landing gifts onto the claimable code-only model (backend) ([8637bec](https://github.com/k4lantar4/remnabot/commit/8637bec1e82e6535cc4bc8ec331a362d5311cb9b))
* **i18n:** add 159 missing localization keys across all 5 locales ([a694eb0](https://github.com/k4lantar4/remnabot/commit/a694eb0be1da4ad1f28e8ecba527a7fadb02b8b6))
* **i18n:** full locale parity — fill 142 gap keys into en/ua/zh ([9390af7](https://github.com/k4lantar4/remnabot/commit/9390af72d36bc001f0afd4b5d352ca1569bf37e8))
* **landing-stats:** add payment-method, traffic-source & gift-claim breakdowns ([357f4c1](https://github.com/k4lantar4/remnabot/commit/357f4c18d45dc638fbdb117d0f32226295d5611f))
* **migration:** evening backup source, purge CLI, anchor 19:00 UTC ([a262387](https://github.com/k4lantar4/remnabot/commit/a2623874057139e956793f0755ac2a61287d32f5))
* **migration:** one subscription per 3x-ui email instead of tariff merge ([d22d900](https://github.com/k4lantar4/remnabot/commit/d22d90018042dc0d62b3040946bf71573ef2f7d6))
* **migration:** re-migration per-email from Feb 28 evening backup ([3e61737](https://github.com/k4lantar4/remnabot/commit/3e61737c063b183c81be6e2e059c65773fd74cee))
* **migration:** re-migration per-email from Feb 28 evening backup ([3e61737](https://github.com/k4lantar4/remnabot/commit/3e61737c063b183c81be6e2e059c65773fd74cee))
* multi-account subscriptions + smoke balance/renew fixes ([709f76e](https://github.com/k4lantar4/remnabot/commit/709f76ef56e3cd5364ec483525342880de6226d6))
* **panel:** neutral multi-account usernames from account_sequence ([1c9a71d](https://github.com/k4lantar4/remnabot/commit/1c9a71d007ca8fcd6053cc328c15b0f6cf688dab))
* **purchase:** same-tariff rebuy creates new account unless renew pinned ([8e7e25a](https://github.com/k4lantar4/remnabot/commit/8e7e25abd0fd7bd8c359349e5fd8095418d661f9))
* **remnawave:** cache panel username on panel-to-bot sync (read-only) ([51a5c53](https://github.com/k4lantar4/remnabot/commit/51a5c53a1fda4166d1ebd4bcca3b6a3656ff6178))
* **sales-stats:** доход без ручных пополнений + новые платные подписки ([a18cb55](https://github.com/k4lantar4/remnabot/commit/a18cb55b4f3722f7576832747a990e6b434559c7))
* **sales-stats:** метрика возвратов в сводке ([fcf1ca0](https://github.com/k4lantar4/remnabot/commit/fcf1ca081304747521542178f1adeae29e5f3b2b))
* **sales-stats:** метрика здоровья оплат (success-rate + неудачные покупки) ([b69021c](https://github.com/k4lantar4/remnabot/commit/b69021c75feca5a18f2df885f9c416732be35d95))
* **security:** email account merge via emailed OTP + initiator-bound execute ([74a78ea](https://github.com/k4lantar4/remnabot/commit/74a78ea1dc40f4186b7fd65512dd9bd4739c892d))
* **subs:** account_sequence counter and partner-unlimited cap helper ([233f89c](https://github.com/k4lantar4/remnabot/commit/233f89cfec321deb10409497895b5b0c9da323b8))
* **subs:** add panel_username display cache column ([cb0a49d](https://github.com/k4lantar4/remnabot/commit/cb0a49d6ee5f8b0b33b063d366be4102e9a8d246))
* **subs:** add subscription_account_label helper for legacy panel names ([5c990b1](https://github.com/k4lantar4/remnabot/commit/5c990b193347dc6b55da95b243ffd21aea0a3d60))
* **subscriptions:** add legacy-aware search filter for my subscriptions list ([40a6733](https://github.com/k4lantar4/remnabot/commit/40a673361a238cde0786f431cf6abe691070b58a))
* **subscriptions:** FSM state for my subscriptions search ([4eab38b](https://github.com/k4lantar4/remnabot/commit/4eab38b045a4a79933c642a610f611a77030c860))
* **subscriptions:** search handlers for my subscriptions list ([d8c397a](https://github.com/k4lantar4/remnabot/commit/d8c397aeebe36b93992fd3bbd67d653a62b96a56))
* **subscriptions:** search in my subscriptions list (multi-tariff) ([a1b01f5](https://github.com/k4lantar4/remnabot/commit/a1b01f554baa158b57d65614b9f4b61c388a193e))
* **subscriptions:** search/reset buttons on my subscriptions keyboard ([2e5d510](https://github.com/k4lantar4/remnabot/commit/2e5d510f43e72457965b4915d01187c5a2f0b97d))
* **subscriptions:** wire menu_subscription state + search handler registration ([cd1083f](https://github.com/k4lantar4/remnabot/commit/cd1083f44b74bb16cf3d09d6d12f9a71b0d7e168))
* **subs:** store panel_username after panel user create ([de8922f](https://github.com/k4lantar4/remnabot/commit/de8922f98f31e4fe2e3969b6b8ba429b32cddecb))
* **tariff:** 10k Toman/GB custom traffic pricing and partner wholesale ([318e88e](https://github.com/k4lantar4/remnabot/commit/318e88eb2ec9e106356b756c5f36ce9562df28a0))
* **tariff:** hide purchase menu prices via TARIFF_PURCHASE_HIDE_PRICES ([#47](https://github.com/k4lantar4/remnabot/issues/47)) ([107cca9](https://github.com/k4lantar4/remnabot/commit/107cca90099bba82eb53ebda10ea2fee2c0112b8))
* **tariff:** post-migration apply script for tariffs 1-3 ([0611aed](https://github.com/k4lantar4/remnabot/commit/0611aed65acc95ffdacbc59e2c3b96208278841a))
* **tariff:** post-migration audit + apply scripts, Persian tariff names ([26cdde9](https://github.com/k4lantar4/remnabot/commit/26cdde9b48c7110b582d77377b38b1dd1510c356))
* **tools:** add x-ui legacy display backfill CLI ([84b8d7c](https://github.com/k4lantar4/remnabot/commit/84b8d7c03e2e942dfd593c488abcbadd6629b6d3))


### Bug Fixes

* **account-linking:** forbid silent OAuth re-link to another account ([357c3d7](https://github.com/k4lantar4/remnabot/commit/357c3d72d201e8c55f4741c27233a30413b603c6))
* **account-merge:** не падать на общем реферере и не терять юзера в панели ([3de2a78](https://github.com/k4lantar4/remnabot/commit/3de2a788d96df3093be0f70a88d1e1d785594a62))
* **admin-notify:** servers display fallback on renewal ([fef9e1d](https://github.com/k4lantar4/remnabot/commit/fef9e1d68fc55c0693b8e6cdf8c79010b8007e73))
* **admin-notify:** servers display fallback on renewal ([a8e02f2](https://github.com/k4lantar4/remnabot/commit/a8e02f232e0bd1af40a46b3b9e65d2b4097ff9b3))
* **admin-notify:** subscription purchase amount display ([b70507a](https://github.com/k4lantar4/remnabot/commit/b70507a335f1d6370bf348d1a08bf60537df208a))
* **auto-extend:** only auto-extend after top-up if the user enabled autopay ([c9abdd0](https://github.com/k4lantar4/remnabot/commit/c9abdd06f9d56fc03492f8f719012ca968552384))
* **autopay:** add effective_autopay_enabled and fix default fallback ([961351f](https://github.com/k4lantar4/remnabot/commit/961351f44e52ff5c4bc840f8132b5b1dc998b544))
* **autopay:** block enabling when ENABLE_AUTOPAY is false ([5019766](https://github.com/k4lantar4/remnabot/commit/5019766daba47a8ce15a2f3992fe686736d07a29))
* **autopay:** global kill switch + C2C top-up amount parse ([7542375](https://github.com/k4lantar4/remnabot/commit/7542375b2b7a1eb2f424eafaf08ac125c765549f))
* **autopay:** refund balance when the auto-renew extension fails ([e014670](https://github.com/k4lantar4/remnabot/commit/e0146700cf303a3589dc3e63c3d388bab4181e72))
* **autopay:** show effective autopay status on all user surfaces ([f780a91](https://github.com/k4lantar4/remnabot/commit/f780a91e27099b6223c9af59ae4738bdcdee5204))
* **autopay:** skip balance autopay when ENABLE_AUTOPAY is false ([812c63a](https://github.com/k4lantar4/remnabot/commit/812c63acb1071cb5fb51b80f60c4cfe2c56becc6))
* **autopurchase:** create new account when cart has no subscription_id ([2a9fd35](https://github.com/k4lantar4/remnabot/commit/2a9fd356f4423c1d712b2d24ba88106fc61e10a1))
* **c2c:** accept plain text payment receipts ([fdac088](https://github.com/k4lantar4/remnabot/commit/fdac0887fa5be1df1e1cf7044e1ee44cb9eefb5a))
* **c2c:** align amount limits and fallback admin topic delivery ([db63ab2](https://github.com/k4lantar4/remnabot/commit/db63ab2d8e9a49109911e2afac65f61fa42adc37))
* **c2c:** always prompt amount before card instructions ([2580294](https://github.com/k4lantar4/remnabot/commit/258029495c0357b1a29f73582d0410878f937bd2))
* **c2c:** correct admin group and topic routing logic ([0e1d748](https://github.com/k4lantar4/remnabot/commit/0e1d748a123d6bbe203f9afbe803a10429c8e4eb))
* **c2c:** credit balance in Toman on receipt approval ([38da214](https://github.com/k4lantar4/remnabot/commit/38da214619959d99b0de7b78a8f3b45e3a313213))
* **c2c:** credit receipt amount 1:1 Toman ([d64a56f](https://github.com/k4lantar4/remnabot/commit/d64a56fd57583ad813170efda7c562302963c157))
* **c2c:** handle admin approve callbacks before group middleware drop ([51ca519](https://github.com/k4lantar4/remnabot/commit/51ca519021be56f0f0908ece6688db39ea2c928c))
* **c2c:** normalize Persian top-up amount text ([7c20105](https://github.com/k4lantar4/remnabot/commit/7c201059ed288a32ef26f26ea3d377bd0cfe5675))
* **c2c:** parse top-up amount as Toman ([b8ca20f](https://github.com/k4lantar4/remnabot/commit/b8ca20fbbdf7971bdae89d7dbef2ae2894488f5c))
* **c2c:** post receipt review to admin group balance topic ([49e12cb](https://github.com/k4lantar4/remnabot/commit/49e12cbadba3c69d7fa9c1219f1d6671344cb644))
* **c2c:** recover receipt session when FSM state lost ([712baf1](https://github.com/k4lantar4/remnabot/commit/712baf12200ad4a59db2dbf5aac50855152c6bc2))
* **c2c:** restore amount prompt and allow admin approve callbacks ([c95d3ee](https://github.com/k4lantar4/remnabot/commit/c95d3eedf5f543e4b3b490783a9f5a688febcbac))
* **cabinet:** admin balance add/subtract use amount_display (Toman 1:1) ([a3cc489](https://github.com/k4lantar4/remnabot/commit/a3cc48959f44ff48a8beef9673f9c6b562d2cbac))
* **cabinet:** balance-scale display for C2C limits and top-up modal ([60e1ee7](https://github.com/k4lantar4/remnabot/commit/60e1ee794a4b57cf92ce762f696a9724eabd6377))
* **cabinet:** bulk add_balance use resolved amount_display ([543d36f](https://github.com/k4lantar4/remnabot/commit/543d36f2ef6156fe5a06607ecd4d475583f5f5d4))
* **cabinet:** catalog purchase creates new account without subscription_id ([675d479](https://github.com/k4lantar4/remnabot/commit/675d4792f279864e12d57c9ae0b0c68940424ed1))
* **cabinet:** compare Toman balance to catalog kopeks prices correctly ([2601f4a](https://github.com/k4lantar4/remnabot/commit/2601f4a7f096eec523e4e063071f44fdb9b3f961))
* **cabinet:** referral earnings rubles use balance-scale display ([7e69cca](https://github.com/k4lantar4/remnabot/commit/7e69ccaab4db3daf5b14267fd4d935309b6961e2))
* **cabinet:** referral network Toman display for fa ([627cab4](https://github.com/k4lantar4/remnabot/commit/627cab48e0041b1a3844e4bc265151f77ddd119e))
* **cabinet:** refund IntegrityError purchase in charged Toman units ([9eefb3f](https://github.com/k4lantar4/remnabot/commit/9eefb3f04484cf051fa0000a6fb4529e92172e3b))
* **cabinet:** renewal balance check uses Toman scale ([b657f9b](https://github.com/k4lantar4/remnabot/commit/b657f9b1f141deea3ea59fded3a791445446254d))
* **cabinet:** show account_sequence in subscription list ([5b3e950](https://github.com/k4lantar4/remnabot/commit/5b3e9500f55586678d2b48347fcee8217aa4ddc9))
* **cabinet:** show referral network amounts in Toman for fa users ([4612fd4](https://github.com/k4lantar4/remnabot/commit/4612fd4ec8ec0b34ad472529740896dc3af73396))
* **cart:** saved-cart renew after /start FSM clear ([e820aa9](https://github.com/k4lantar4/remnabot/commit/e820aa9829027614ae2581c804e86449235dec84))
* **cart:** saved-cart renew pins sub_id after /start FSM clear ([17f2e19](https://github.com/k4lantar4/remnabot/commit/17f2e196355d5486bab2c38d7d8ed4d74984214b))
* **charge:** bot countries addon catalog charge parity ([89da2aa](https://github.com/k4lantar4/remnabot/commit/89da2aa1f4b2b2ff0ae0400152b847860d0e25f7))
* **charge:** bot devices addon catalog charge parity ([c850593](https://github.com/k4lantar4/remnabot/commit/c8505935c16527833b149492eca1e388c40311a4))
* **charge:** bot traffic catalog charge and C2C prefill ([438f178](https://github.com/k4lantar4/remnabot/commit/438f178e5b9fe58f9045c50e517f55b59ad29537))
* **charge:** cabinet daily resume catalog charge parity ([6a1e903](https://github.com/k4lantar4/remnabot/commit/6a1e903a8b742395252adc7775e36f4ccb85656a))
* **charge:** cabinet gift catalog charge parity ([d4fc4ab](https://github.com/k4lantar4/remnabot/commit/d4fc4abb7f278681d8ff7699219f0f2df18c1dcd))
* **charge:** cabinet tariff switch catalog charge parity ([eb36307](https://github.com/k4lantar4/remnabot/commit/eb363079f0dd21484c34fa2ab99a4e253833acd3))
* **charge:** catalog/toman charge parity across bot, cabinet, miniapp ([978d5aa](https://github.com/k4lantar4/remnabot/commit/978d5aa2e6580b5b900cdba945698ea754e7d8e2))
* **charge:** menu activate catalog charge parity ([d1c734c](https://github.com/k4lantar4/remnabot/commit/d1c734cf978e890913a287d78b44b49a113ebcf7))
* **charge:** miniapp catalog_price_in_toman parity ([226df9e](https://github.com/k4lantar4/remnabot/commit/226df9e67b7a4ccd8472eecb9e3ea356fdb219f9))
* **charge:** monitoring autopay catalog charge parity ([e193cef](https://github.com/k4lantar4/remnabot/commit/e193cef361b2e4d95cfd24961ac8570d7d422dc5))
* **config:** coerce empty FIXED_TRAFFIC_LIMIT_GB to default ([3dd4103](https://github.com/k4lantar4/remnabot/commit/3dd41031670bd14d9a12fcbade5daf6a4c0af4ae))
* **contests:** channel start-announce button now works (deep link, not callback) ([663064d](https://github.com/k4lantar4/remnabot/commit/663064d9aacd2d1cfbde4c372b729b6af569df64))
* **contests:** rescue pre-fix channel announcements via callback url-redirect ([be5524d](https://github.com/k4lantar4/remnabot/commit/be5524d792c23d2b39bee752590d4a5e9a30151f))
* **currency:** align transaction history with Phase B balance scale ([39e9bba](https://github.com/k4lantar4/remnabot/commit/39e9bbaa06ee0acbe407d011a0972f182ea4ccca))
* **currency:** amount_display XOR amount_kopeks on balance updates ([8bb1275](https://github.com/k4lantar4/remnabot/commit/8bb127549f616486de6e22cdcb0cb3249542ecad))
* **currency:** auto-purchase balance charge scale ([0814e42](https://github.com/k4lantar4/remnabot/commit/0814e42d6ffe3f255811ce968841f409a533a916))
* **currency:** bot tariff charge scale + top-up DM notification ([fca84cb](https://github.com/k4lantar4/remnabot/commit/fca84cba095aef19e8eebb271fed654eb7e148af))
* **currency:** cabinet balance_rubles via display_amount_from_kopeks ([253877c](https://github.com/k4lantar4/remnabot/commit/253877c4cb0931841c5bedc358cc344c350403bd))
* **currency:** deploy + websocket/notification balance display ([605262a](https://github.com/k4lantar4/remnabot/commit/605262af1fad77633f8a73431e395d1a01fe12dd))
* **currency:** display/kopeks conversion helpers and tests ([efd6207](https://github.com/k4lantar4/remnabot/commit/efd6207088ea2720872fb33aadad94f48c379176))
* **currency:** filter transactions before Phase B cutoff ([241ad3f](https://github.com/k4lantar4/remnabot/commit/241ad3fb0d1877eb5aff549c00d39ee43be08d23))
* **currency:** format_balance in cabinet subscription routes ([cbc64ce](https://github.com/k4lantar4/remnabot/commit/cbc64ceaf9fbf8e80500304a2a31e1836b1db2f9))
* **currency:** Phase C balance scale + webhook Toman credits ([12a91b8](https://github.com/k4lantar4/remnabot/commit/12a91b8181f67542318682b4004d51067332b1a7))
* **currency:** referral commission credits on Toman balance scale ([3e8632f](https://github.com/k4lantar4/remnabot/commit/3e8632fb046907a4ce62791f3345303ea5999074))
* **currency:** show user balances via format_balance ([d9cd537](https://github.com/k4lantar4/remnabot/commit/d9cd53788941b1e8128d03bca33d52ef2f1abf5b))
* **currency:** tariff period preview uses Toman balance vs catalog price ([2a8d879](https://github.com/k4lantar4/remnabot/commit/2a8d879888e0852e158ec20bbd5593c08f7e403d))
* **currency:** tariff_purchase balance charge scale ([3848a41](https://github.com/k4lantar4/remnabot/commit/3848a412588c5f7e75ece1a90dd56202f1eb3f9e))
* **currency:** top-up Telegram DM uses format_balance ([71f32ef](https://github.com/k4lantar4/remnabot/commit/71f32ef005a4fa53009399afb49f4863f37a2e62))
* **currency:** unify tariff_purchase balance display and missing amount ([08e40d9](https://github.com/k4lantar4/remnabot/commit/08e40d9f9c35636da448413cc9d6a73eace46d42))
* **db:** drop subscriptions eager load from lock_user_for_pricing ([6395e18](https://github.com/k4lantar4/remnabot/commit/6395e189a83de272802886c5dc5c3b22735c7d87))
* **deploy:** attach cabinet-frontend to remnawave-network ([0e2ba98](https://github.com/k4lantar4/remnabot/commit/0e2ba98d1837dff3bc26bba353188614bdc3bd22))
* **deploy:** cabinet healthcheck IPv4 and dev compose example ([a58f4aa](https://github.com/k4lantar4/remnabot/commit/a58f4aa3a6a7b7009d95b2ec8975228616945745))
* **display:** hide user_unknown_* panel_username in UI labels ([2fcf103](https://github.com/k4lantar4/remnabot/commit/2fcf103eeb6e95dc4506f4d10d3e73cdb41769f0))
* **display:** Persian period formatting for fa users ([8567004](https://github.com/k4lantar4/remnabot/commit/8567004d391671f9e7598c98c1861030bac43daa))
* don't block handlers on long rate-limit backoff (WATA + channel gate) ([b7c37f9](https://github.com/k4lantar4/remnabot/commit/b7c37f9e4d4aabbbcf3188173f8c466cf64c706e))
* **fsm:** pin target_subscription_id per sub; clear on menu_buy new purchase ([f14f01e](https://github.com/k4lantar4/remnabot/commit/f14f01e70fe5d20a8f0c5ebac031e063e8e6ba05))
* **gift:** finish cabinet unification + close review regressions ([c2488b6](https://github.com/k4lantar4/remnabot/commit/c2488b63c334d254257e50540d290b872d63d1df))
* **guest-payment:** подарок/гость через шлюз с под-методом (rollypay_sbp и др.) ([837e9e6](https://github.com/k4lantar4/remnabot/commit/837e9e65a520bfd864ac13a35f7c3d76cb2fe888))
* **guest-purchase:** roll back poisoned session on accounting-tx failure ([f986d36](https://github.com/k4lantar4/remnabot/commit/f986d3638bf748f735f7e3ec29f748ba78467315))
* **guest:** allow multiple same-tariff accounts under cap ([0f20c13](https://github.com/k4lantar4/remnabot/commit/0f20c1324871cf430e4d1ec0ff4e0edcff712389))
* **i18n:** accept round_kopeks kwarg in format_balance ([48c252c](https://github.com/k4lantar4/remnabot/commit/48c252c434c572749de1099c7c9534907a6aac41))
* **i18n:** align ADMIN_USER_MANAGEMENT_PROFILE placeholders in fa.json ([c01ca3b](https://github.com/k4lantar4/remnabot/commit/c01ca3bdfc7327a1899472b6680fbd80125e91f6))
* **i18n:** don't warn when t()/get() is given an explicit fallback ([d108687](https://github.com/k4lantar4/remnabot/commit/d1086879e9a9301176759ec783deda75fd7e8d14))
* **i18n:** repair 38 stale translations with drifted placeholders ([ee8ddb7](https://github.com/k4lantar4/remnabot/commit/ee8ddb74b76e6427d42c1682ea511d5f56c719a3))
* **keyboard:** dedupe redundant buy button for new users (multi-tariff) ([c79644c](https://github.com/k4lantar4/remnabot/commit/c79644c38aba0e5856b491af0c43cecee8f7ac30))
* **landing:** суточные тарифы на лендингах показывали цену 0 и не покупались ([b795583](https://github.com/k4lantar4/remnabot/commit/b795583c7963e7b6b640638af91067616b389bb2))
* **menu:** cap multi-tariff preview at three with overflow line ([bf48916](https://github.com/k4lantar4/remnabot/commit/bf48916b192f58d8b30db3b3356cf084144b8848))
* **menu:** per-sub management only in multi-tariff; route buy to menu_buy ([0f9e026](https://github.com/k4lantar4/remnabot/commit/0f9e02613a24f87c884465b90ca86478db4b9bfd))
* **menu:** send main menu with logo on /start paths ([5cb3e0a](https://github.com/k4lantar4/remnabot/commit/5cb3e0a3839c06b3848ffbaee90b247abe13130c))
* **menu:** single get_main_menu_text source — start imports menu.py ([0efb3a8](https://github.com/k4lantar4/remnabot/commit/0efb3a87507cb30fef9ff6af7a721481225b5cd9))
* **menu:** unify /start and back_to_menu main menu rendering ([0891696](https://github.com/k4lantar4/remnabot/commit/08916962e6576253646af64495405c61ff3e1ed1))
* **migration:** ensure premium/basic tariff rows before load ([81252dc](https://github.com/k4lantar4/remnabot/commit/81252dcda4836f0197789eead68ae75e55755844))
* **my-subs:** edit caption on photo messages for search flow ([7275e33](https://github.com/k4lantar4/remnabot/commit/7275e336492bcb4a730390bd38334e5e2ccf020d))
* **my-subs:** paginate list and show two subscription buttons per row ([63dd89b](https://github.com/k4lantar4/remnabot/commit/63dd89be6c7d1a57fa67c26c90120c9e5bd7296a))
* **my-subs:** paginated 2-column subscription list ([0097096](https://github.com/k4lantar4/remnabot/commit/009709670fb0eb36f27901407190c1c4ff1a3551))
* **my-subs:** paginated 2-column subscription list ([0097096](https://github.com/k4lantar4/remnabot/commit/009709670fb0eb36f27901407190c1c4ff1a3551))
* **my-subs:** use edit_or_answer_photo and shared message_edit util ([a855491](https://github.com/k4lantar4/remnabot/commit/a8554911e562132cb56856725174010043088efb))
* **panel-sync:** partner-unlimited subscription import guard ([934ab2a](https://github.com/k4lantar4/remnabot/commit/934ab2a165de664a8d51a0e45a418d8a0e65dbc5))
* **payment:** register C2C in available payment methods ([adeb757](https://github.com/k4lantar4/remnabot/commit/adeb75732da57483431d06faae575ca4e95d6f30))
* **payments:** yookassa webhook log crash + miniapp pal24 dropped card/sbp choice ([3935042](https://github.com/k4lantar4/remnabot/commit/3935042d79f1ffa79cf5d95d255576b0110a0db0))
* **promo:** use Persian default promo group name ([5f52bbf](https://github.com/k4lantar4/remnabot/commit/5f52bbf0cdee01b2e38f23f43f373d58e01e8529))
* **purchase:** allow rebuy same tariff in multi-tariff select_tariff ([d34d452](https://github.com/k4lantar4/remnabot/commit/d34d45219dc66599117acb13acbec31a818ab3b3))
* **purchase:** tariff list price for custom-traffic tariffs ([fea96f4](https://github.com/k4lantar4/remnabot/commit/fea96f474f9cdbb3291a11ce2d402208a920caeb))
* **purchase:** traffic-first flow and period pricing ([7ba715d](https://github.com/k4lantar4/remnabot/commit/7ba715d6b7b0deda7593459a06fab0c3a57e69c7))
* **purchase:** traffic-first UX for custom-traffic tariffs ([253fce2](https://github.com/k4lantar4/remnabot/commit/253fce245e28d5202e40bb2aa01f675fbfb102b3))
* **referral:** keep invite links in the clipboard via &lt;code&gt; ([#634720](https://github.com/k4lantar4/remnabot/issues/634720)) ([15d2996](https://github.com/k4lantar4/remnabot/commit/15d29960a4efd7448273e139007ec406a5badbaa))
* **remnawave-api:** не сыпать 404 «not found» в админ-чат (понизить до warning) ([ed9d4e1](https://github.com/k4lantar4/remnabot/commit/ed9d4e13753233c9bf6cab9a153bca1ab3b36c3b))
* **remnawave-sync:** пересоздавать панель-юзера и по коду A063, не только A018 ([05c7517](https://github.com/k4lantar4/remnabot/commit/05c7517a41d258641aa4f32c61dbd17a08abd01b))
* **remnawave:** multi-tariff panel usernames use real user id + account label ([db79eaf](https://github.com/k4lantar4/remnabot/commit/db79eaf1180de12cfc7e60139e4bd5ee824e7409))
* **remnawave:** revert panel username to upstream create-only path ([c4411df](https://github.com/k4lantar4/remnabot/commit/c4411df557c574ff38d21099556010cd26593ec1))
* **remnawave:** revert panel username to upstream create-only path ([3d81165](https://github.com/k4lantar4/remnabot/commit/3d81165a4ece2572ffb61e103d7abf9bfe6fc10f))
* **renewal:** back navigation to subscription detail in multi-tariff ([f8dc28c](https://github.com/k4lantar4/remnabot/commit/f8dc28c157163dd01ce1e282cd4e3a3a2d0b4578))
* **renewal:** P0 renewal UX + Persian tariff descriptions ([2b09e9f](https://github.com/k4lantar4/remnabot/commit/2b09e9f43e60db46b2dcdf94e1379a261bc22784))
* **renewal:** persist custom traffic on extend ([898fc02](https://github.com/k4lantar4/remnabot/commit/898fc028a94054c41dbed3f550225da533524171))
* **renewal:** price custom-traffic tariffs from subscription GB ([9397788](https://github.com/k4lantar4/remnabot/commit/93977887ba73360a34c1e9e5678bd2bf44817c24))
* **renewal:** resolve subscription from FSM before multi-sub picker ([5a314e6](https://github.com/k4lantar4/remnabot/commit/5a314e63ca90b18e83ee4216182491f617bdf9d4))
* **renew:** tariff_ext_confirm uses FSM sub pin not period suffix ([9fb7503](https://github.com/k4lantar4/remnabot/commit/9fb750314b35e6a87838033ab135b57278e2876a))
* **sales-stats:** возвраты — только реальные, не внутренние откаты ([cec8e27](https://github.com/k4lantar4/remnabot/commit/cec8e271810e167d695452965576f668f498d97e))
* **sales-stats:** корректный средний чек в продажах ([0645565](https://github.com/k4lantar4/remnabot/commit/06455657900676fab9cfa4f0cc43743e4335ab63))
* **sales-stats:** продления больше не считают докупки трафика/устройств ([bc36187](https://github.com/k4lantar4/remnabot/commit/bc361874f50f0530b5ea263a84d392040dc07dd4))
* **sales-stats:** считать выручку с подарков, оплаченных через шлюз ([fafb966](https://github.com/k4lantar4/remnabot/commit/fafb966b31cf6f95ed42375e5e290da8bb0db893))
* **security:** admins can only grant permissions they hold (RBAC privilege escalation) ([f73f73f](https://github.com/k4lantar4/remnabot/commit/f73f73f0be4157c58da53b084643eb8b4959e78f))
* **security:** block identity/auth secrets from the settings API (privilege escalation) ([c5a52c4](https://github.com/k4lantar4/remnabot/commit/c5a52c4454a8f6c22193cf1504a39978173caa61))
* **security:** harden email-change OTP against brute force + admin-email binding (ATO) ([4c53e94](https://github.com/k4lantar4/remnabot/commit/4c53e9416bc484f5499398a1f3ecdebd41971d23))
* **security:** redact sensitive values in admin settings logs ([462a654](https://github.com/k4lantar4/remnabot/commit/462a654ee0c8f843d84fad2002c5b4e6053ed7d2))
* **security:** require existing-account password before email-link merge (account takeover) ([0c56a04](https://github.com/k4lantar4/remnabot/commit/0c56a04d5796799459f3ff2d8a50dfce143d94c6))
* **security:** sign + expire media download URLs (close ticket-attachment IDOR) ([f5c02cd](https://github.com/k4lantar4/remnabot/commit/f5c02cd0f5b3f64992b9bc02a9b6c1de04119e56))
* **security:** stop shared-cache leakage of private ticket attachments + validate file_id ([881a1ed](https://github.com/k4lantar4/remnabot/commit/881a1ed78b66c168375ca9106c7fb8360fa72fea))
* **security:** Telegram Login Widget one-time-use + 24h window (replay/ATO) ([b1e8ca4](https://github.com/k4lantar4/remnabot/commit/b1e8ca48295a6e1b5235e9e101dc88a23f2f029b))
* **smoke:** C2C amount prompt, cabinet renewal scale, admin notify price ([a8c2b5f](https://github.com/k4lantar4/remnabot/commit/a8c2b5f9d6dcacd1805df8c53d87b921144d0d16))
* **stars:** atomic subscription activation + idempotent payment ([5b79b30](https://github.com/k4lantar4/remnabot/commit/5b79b30469cf6a8d1b5224162cf8235b85ccb08e))
* **start:** wire send_main_menu_to_chat for all main menu sends ([741825e](https://github.com/k4lantar4/remnabot/commit/741825e12cb7e6ddfe91b8a4ed790d7e4e69387e))
* **stats:** учитывать ВСЕ платёжные шлюзы в доходе (Jupiter/Donut/Lava пропадали) ([d30b821](https://github.com/k4lantar4/remnabot/commit/d30b821c970ab3127e3df1fc44dc873fdfcdcd07))
* **subscriptions:** дедуп без удаления панель-юзеров (защита от A063 404) ([fb1d72f](https://github.com/k4lantar4/remnabot/commit/fb1d72f72cfb24e6490c6d6ff2f9559f87ee6ccf))
* **subscriptions:** реанимировать истёкший тариф при повторной покупке вместо дубля ([2831982](https://github.com/k4lantar4/remnabot/commit/2831982a320e9970beee47f541790df6c06db794))
* **subscriptions:** чистить дубли через сервис (БД + панель), не DB-only миграцией ([45189b2](https://github.com/k4lantar4/remnabot/commit/45189b2bd40a0fb72b03b5df2fa6b06855c84b14))
* **tariff_purchase:** NameError in _calc_extra_devices_cost for extend keyboard ([5bf7481](https://github.com/k4lantar4/remnabot/commit/5bf7481f550a003990fc0bac30ed8ac62bc7c228))
* **tariff:** extend migration placeholder guard to switch flows ([c264c4c](https://github.com/k4lantar4/remnabot/commit/c264c4c857e5863f4827feb2016c4739061cb232))
* **tariff:** hide migration placeholder descriptions ([d61f091](https://github.com/k4lantar4/remnabot/commit/d61f0915354dfaeafcd7013e1bab5000a71230bc))
* **tariff:** partner promo group resolution and tariff visibility ([daf2dbf](https://github.com/k4lantar4/remnabot/commit/daf2dbfad64753f9d637ddfe920a23db2a6a7d12))
* **tariffs:** update_tariff принимает trial_duration_days ([51a2e11](https://github.com/k4lantar4/remnabot/commit/51a2e11c6eb508db0c34293041b74e2aed4dbc83))
* **tariff:** unify promo group resolution for partner tariff visibility ([ed8bc14](https://github.com/k4lantar4/remnabot/commit/ed8bc146e69d499a067ea4600fe129c0cbde7f1b))
* **topup:** only auto-buy saved cart on a fresh, explicit top-up intent ([66876fc](https://github.com/k4lantar4/remnabot/commit/66876fcb7223d923a195bafc0175bbeddcecd128))
* **traffic:** run package-reset job even when daily tariffs are off ([#630055](https://github.com/k4lantar4/remnabot/issues/630055)) ([c93cf48](https://github.com/k4lantar4/remnabot/commit/c93cf48363216e97ce3408781c82588d9daae90f))
* **trial-reset:** cabinet reset deletes the panel user too, not just disable ([c4e65d5](https://github.com/k4lantar4/remnabot/commit/c4e65d56ac680874cfc99cf2d5532001796d6282))
* **trial-reset:** wipe the Remnawave panel user on bulk trial reset, race-safe ([6b6bad1](https://github.com/k4lantar4/remnabot/commit/6b6bad18d73ebc694c75cafbcd9d3708a65ced3e))
* **trial:** 0 ГБ на триал-тарифе = безлимит, не подмена конфигом ([1713452](https://github.com/k4lantar4/remnabot/commit/17134523dd7d4917fb8de4bd2d4a43e7d7de1d29))
* **trial:** block trials from tariff-switch & gate trial conversion in extend_subscription ([#629889](https://github.com/k4lantar4/remnabot/issues/629889)) ([7844f1a](https://github.com/k4lantar4/remnabot/commit/7844f1ab9080398d6beed651ae70e427fe8e22f0))
* **trial:** gate on tariff flag + cabinet i18n ([0876059](https://github.com/k4lantar4/remnabot/commit/0876059568673213094058a70cdb0d4d43cbc9f0))
* **trial:** gate user trial on tariff availability ([94a7f5d](https://github.com/k4lantar4/remnabot/commit/94a7f5df907b56620720cf85a80a64f3f7e43c56))
* **trial:** keep trials a trial on tariff relabel & days-promo ([#629889](https://github.com/k4lantar4/remnabot/issues/629889)) ([acb2242](https://github.com/k4lantar4/remnabot/commit/acb224260d25c38efac65221819d0022d2e358f7))
* **trial:** кабинет не должен отбраковывать неактивный триал-тариф ([e197857](https://github.com/k4lantar4/remnabot/commit/e197857063e0f9051822288a3f900252e2fed9e5))
* **web-api:** make /health a public liveness probe (was 401 for healthchecks) ([2450220](https://github.com/k4lantar4/remnabot/commit/2450220ac0cb17aa8eabb1a80d9dfc42ff3751c4))
* **webhooks:** atomic, single-transaction balance credit for Tribute + Stars ([644fb45](https://github.com/k4lantar4/remnabot/commit/644fb45c5f88517502bd82faae15d8a0e7d759c8))
* **wheel:** expose won prize_id in spin history for exact sector landing ([6277fa5](https://github.com/k4lantar4/remnabot/commit/6277fa5012df650525b3963de11ae013e7ecbbdc))
* **wheel:** make Telegram Stars spins idempotent + enforce daily limit ([ae3fa8b](https://github.com/k4lantar4/remnabot/commit/ae3fa8b1a4bb037ca442c3cea3c80648fb34423f))
* **wheel:** serialize spins to close daily-limit & days-payment races ([cbe134d](https://github.com/k4lantar4/remnabot/commit/cbe134d81938c20c160287ce1dd882ec7b08160a))
* **yookassa:** credit balance in Toman at webhook ([07ff704](https://github.com/k4lantar4/remnabot/commit/07ff704eb2aac644e529cf5195360adab23fb334))
* **yookassa:** идемпотентное создание платежа, без ложного «FK violation» спама ([ca8b9c8](https://github.com/k4lantar4/remnabot/commit/ca8b9c84d87f864337d5c746646d0071b9217474))


### Refactoring

* **cabinet:** use shared subscription display label in list card ([91b9145](https://github.com/k4lantar4/remnabot/commit/91b9145bee54afe4589ae2321a4692d341ebdbc2))
* **logs:** repair degraded log messages across the codebase ([e3f5da8](https://github.com/k4lantar4/remnabot/commit/e3f5da86b890d06ad29bb7287c2075f3117903c9))
* **menu:** handle_back_to_menu delegates to show_main_menu ([011ac37](https://github.com/k4lantar4/remnabot/commit/011ac379ad7b0b050551b4e0a982439e3e2d8242))
* **subscriptions:** shared builder for my subscriptions list ([eb39dfb](https://github.com/k4lantar4/remnabot/commit/eb39dfb8db6ea54c06eb18615bc4d1aceeb85470))
* **trial-reset:** extract shared wipe_trial_subscriptions helper (dedup) ([fb0be88](https://github.com/k4lantar4/remnabot/commit/fb0be880a3286bda9d35da4bed36a174dadda64b))
* **trial:** one canonical trial-eligibility gate (dedup 4 copies) ([c272a15](https://github.com/k4lantar4/remnabot/commit/c272a159bdcc887202a3afa782b1adf0894afb1a))
* **trial:** unify cabinet trial gates + drop dead has_used_trial flag ([f624d2d](https://github.com/k4lantar4/remnabot/commit/f624d2de40d85f0d344794ae5bbdaf255470822c))


### Documentation

* **currency:** phase-c executed checklist and webhook inventory ([345c689](https://github.com/k4lantar4/remnabot/commit/345c689acecf78dc96a5eca68081e70035d4f530))
* **currency:** phase-c+ webhook shipped and deferred inventory ([5d39b3f](https://github.com/k4lantar4/remnabot/commit/5d39b3f0105420bb85b61c3f1dea95016fc6dc71))
* **fa-i18n:** update status after P1 admin batch ([6e56acc](https://github.com/k4lantar4/remnabot/commit/6e56acc11238a02ece32f7742730083602679b9e))
* **i18n:** add fa-remaining execution and audit plans ([d06108f](https://github.com/k4lantar4/remnabot/commit/d06108ffef2263d176326c461184f92eba1a5c2a))
* **i18n:** close user_unknown remediation scope ([056c17a](https://github.com/k4lantar4/remnabot/commit/056c17aed9c4485d60b2884cd24f0e9ac16a9056))
* **i18n:** close user_unknown remediation scope ([d6cef9f](https://github.com/k4lantar4/remnabot/commit/d6cef9ffedc17957744458554b3260b75e37f679))
* **i18n:** record fa Jalali dates P1 completion ([2f27f0e](https://github.com/k4lantar4/remnabot/commit/2f27f0e7e589d1c40139cd3cc3bbe8f6086dc9ec))
* **i18n:** update fa-i18n-status after remaining work ([4fe766c](https://github.com/k4lantar4/remnabot/commit/4fe766cb61744096a131c7905b8607f14c842462))
* **i18n:** update fa-i18n-status for upstream 3.59 merge ([b36e372](https://github.com/k4lantar4/remnabot/commit/b36e372d0b5d10e8d346e615fd5ff364d13ec884))
* **i18n:** update fa-i18n-status P2 completion ([cf540ee](https://github.com/k4lantar4/remnabot/commit/cf540ee77f403d3b280b1d9addb66c6b48f5db76))
* **plan:** fa Jalali dates implementation plan ([ae1aa2b](https://github.com/k4lantar4/remnabot/commit/ae1aa2bab6bcfd08c92d57e586a7f38455f8dc24))
* **readme:** убрать партнёрство с WATA, шлюз оставить ([f3a215b](https://github.com/k4lantar4/remnabot/commit/f3a215bb9066bae3b8c840d8750f21500eef47b1))
* save post-migration tariff i18n plan ([60c72f6](https://github.com/k4lantar4/remnabot/commit/60c72f68d9a458b03d7711719e15b5d65e26697e))
