...
## [5.0.0](https://github.com/k4lantar4/remnabot/compare/v4.2.0...v5.0.0) (2026-09-08)
...
* activate gift codes in bot ([81c5591](https://github.com/k4lantar4/remnabot/commit/81c5591ae3c6390d9351c25c36f55edc9c5091ed))
* add crash-safe restricted grace access for expired and limited subscriptions ([67d45b6](https://github.com/k4lantar4/remnabot/commit/67d45b6ac39cd4203c870da42a3680c5068beb21))
* add idempotent gift balance service ([6e87564](https://github.com/k4lantar4/remnabot/commit/6e875643b23a74730b06fbfcb65f5398f9bcfdad))
* add native gift selection flow ([8c90b76](https://github.com/k4lantar4/remnabot/commit/8c90b760dd6e7a97f5007b744e95ff204889521f))
* add recoverable gift history ([1128018](https://github.com/k4lantar4/remnabot/commit/1128018dd205811a0a441d68af7a19f604de233a))
* add sender gift history service ([ef8cdb5](https://github.com/k4lantar4/remnabot/commit/ef8cdb51df049a25358d90ed3ad527abcc7d4639))
* add typed ban notification templates ([30878b1](https://github.com/k4lantar4/remnabot/commit/30878b156ac1efe42338c28fbdfead8bcd68feb6))
* **admin:** add Bedolaga-first User Detail contracts ([57e2794](https://github.com/k4lantar4/remnabot/commit/57e2794f55ba8cff918ff5c622bb6bbf9df9afb5))
* **admin:** resolve users by subscription remnawave uuid ([101f0fc](https://github.com/k4lantar4/remnabot/commit/101f0fc578f71bdce45e3c3259e199018872c7e9))
* **auth:** add system-wide invite-only registration ([b639273](https://github.com/k4lantar4/remnabot/commit/b639273dfd1783f6aac09b16241b1a6efee726eb))
* **auth:** добавить системный режим регистрации только по приглашениям ([dce9336](https://github.com/k4lantar4/remnabot/commit/dce933662eb3004fbe532f0faba5a2d30e56d4a2))
* **cabinet:** панельная идентичность и контракты под 3.0.0 ([2b97440](https://github.com/k4lantar4/remnabot/commit/2b9744049dcfce6677e44442490202f08b31b0a9))
* **cabinet:** раздел grace-доступа в админке ([f7010f2](https://github.com/k4lantar4/remnabot/commit/f7010f2538ae6038859fa3b852b90bcef1d609c3))
* **cabinet:** согласие с офертой и политикой при первой авторизации ([3b0306f](https://github.com/k4lantar4/remnabot/commit/3b0306fae60ac2ad905d6c10c35402167d983902))
* **cabinet:** удаление конкретной подписки из карточки пользователя ([56a9959](https://github.com/k4lantar4/remnabot/commit/56a9959d7738d6b646bcfd001b5de265a683b604))
* **config:** TRAFFIC_EXCLUDED_USER_UUIDS переименован в _USER_IDS ([88a92f7](https://github.com/k4lantar4/remnabot/commit/88a92f794267f599bba993811119cccba72fb2f7))
* **coupons:** лимит активаций на пользователя и удаление партий ([8260944](https://github.com/k4lantar4/remnabot/commit/82609441ae29e24d9037ce77b8299836a6ec8844))
* **day1:** add jdatetime so fa dates convert to Jalali ([58c95d8](https://github.com/k4lantar4/remnabot/commit/58c95d8a79683f12e15e6c451be9d8b9f294a936))
* **day1:** Jalali fallback on rich-menu table and purchase expire date ([d6664a9](https://github.com/k4lantar4/remnabot/commit/d6664a9941d0ddc7ab5b13b715579e8d16d2ebe2))
* **day1:** map brand prefix, purchase note, and user_disabled on ORM ([9419dc7](https://github.com/k4lantar4/remnabot/commit/9419dc7fa140aa12520ff2632a7aa22fa59d29c2))
* **day1:** My Subscriptions search overlay on 4.2 list ([80e0d2a](https://github.com/k4lantar4/remnabot/commit/80e0d2ae89ed506a9d066df2886d4df045128a56))
* **day1:** overlay My Subscriptions list chrome via helper ([4d2c2e9](https://github.com/k4lantar4/remnabot/commit/4d2c2e999e0e36a66adcd27b8ad0081c7f2ea89a))
* **day1:** partner note and brand overlay on 4.2 tariff confirm ([29e5a5c](https://github.com/k4lantar4/remnabot/commit/29e5a5cee652337d18861cb98f1f1712eb3c373b))
* **day1:** subscription list identity, Jalali line, and search filter ([84b6155](https://github.com/k4lantar4/remnabot/commit/84b61556ab61b97359219eeddd4b32de8a7eeda0))
* **day1:** Telegram pause/resume via user_disabled ([94e77d1](https://github.com/k4lantar4/remnabot/commit/94e77d158953ab86a3f6434274d05e6c28b46196))
* **db:** числовая панельная идентичность remnawave_id ([898bcf4](https://github.com/k4lantar4/remnabot/commit/898bcf49bcb829e54a02808c0af1055216d81837))
* **devices:** запрет уменьшать лимит устройств ниже включённого в тариф ([8aafb64](https://github.com/k4lantar4/remnabot/commit/8aafb648b97830aabf885eda47954f92fe888a6f))
* **email:** deliver winback + lifecycle notifications to email-only users ([491f61f](https://github.com/k4lantar4/remnabot/commit/491f61ffb1b44737f9ce60511adc0b57493deea2))
* **email:** email templates for all Remnawave WEBHOOK_* notifications ([a14389f](https://github.com/k4lantar4/remnabot/commit/a14389f8f80a33c14fd18b6a4c4b1e70aac641a1))
* **email:** recurrent autopay success/failure to email-only users ([ba9555c](https://github.com/k4lantar4/remnabot/commit/ba9555c5cad8a15e9c372da2df659f55b0011f55))
* **email:** заголовок Reply-To (SMTP_REPLY_TO) ([6a26e39](https://github.com/k4lantar4/remnabot/commit/6a26e397d3b2366d5bc24a48af3b2c6c49f5dba5))
* **email:** отписка от маркетинговых писем (one-click, RFC 8058) ([4825527](https://github.com/k4lantar4/remnabot/commit/482552705400a44e8afb83904a310875fa4261fb))
* expose canonical gifts in cabinet api ([5bf8a9a](https://github.com/k4lantar4/remnabot/commit/5bf8a9aa1b2b78cda07951d395c5e3a8cd347013))
* **gift:** QR-код подарка и готовый текст для отправки ([810ed7f](https://github.com/k4lantar4/remnabot/commit/810ed7ffd10d833a3df867609ccf08760587b7d6))
* **gift:** добавить дарение подписок между ботом и кабинетом ([8d71f77](https://github.com/k4lantar4/remnabot/commit/8d71f774f2ce68bd5cbca43808824c1f93fb4f4b))
* **grace:** allow configuring external squad via GRACE_ACCESS_EXTERNAL_SQUAD_UUID ([e2d5f3e](https://github.com/k4lantar4/remnabot/commit/e2d5f3e0d0ba012552b53370108388a9bad37062))
* **grace:** упростить квоту трафика и правила доступности ([2e40235](https://github.com/k4lantar4/remnabot/commit/2e40235e60677550ca975904c381414d2ae8a4d0))
* **landing:** засчитывать гостевую покупку в рекламную кампанию ([1c46702](https://github.com/k4lantar4/remnabot/commit/1c46702cdf18c437c71de6d0129a65cdfa0f4794))
* **landing:** засчитывать гостевые покупки в рекламные кампании ([7203ca9](https://github.com/k4lantar4/remnabot/commit/7203ca9f88cf5f37d82cdb0476f417799d621a6e))
* **landing:** сохранять слаг рекламной кампании в гостевой покупке ([4a81705](https://github.com/k4lantar4/remnabot/commit/4a81705d277c5e2fd92da47907e04cf8b4abb590))
* **lava:** кабинет-эндпоинты автопродления Lava ([0dea218](https://github.com/k4lantar4/remnabot/commit/0dea218298be16111e61572d9d450154e3f476a3))
* **lava:** паритет покупки привязкой, уведомления, сверка суммы ([de3518b](https://github.com/k4lantar4/remnabot/commit/de3518b763fb1a49d38629472969115a18014134))
* **lava:** рекуррентные подписки Lava по образцу Platega ([9d1772b](https://github.com/k4lantar4/remnabot/commit/9d1772bcfe26a3ef75bb8a47e7e33180d1fa3cba))
* **M1-T1:** isolated rehearsal compose ([141fa62](https://github.com/k4lantar4/remnabot/commit/141fa6290c1fa8a9e304b3aa512612170f5e0a84))
* **M1-T2:** fail-closed production token guard ([ed2334e](https://github.com/k4lantar4/remnabot/commit/ed2334e6256c86a08f88c172aeb1e1e87e7bd460))
* **M2-T0:** pin Remnawave 2.8.1 restore runtime digest ([f32e44c](https://github.com/k4lantar4/remnabot/commit/f32e44c05ddcac8bbd8a02e19f12612eeacb1258))
* **M3-T1:** upgrade rehearsal RW copy 2.8.1 → 3.4.3 (G3 PASS) ([a3aadc1](https://github.com/k4lantar4/remnabot/commit/a3aadc1ccfa6789286ec3f6d82512f4ec0ba4419))
* **M4-T0:** graft remnabot alembic 0088-0104; archive upstream 0088-0110 ([28259a7](https://github.com/k4lantar4/remnabot/commit/28259a70a3164e897a939faa3eabfaae18d43f89))
* **M4-T2:** verify remnabot1 3.x client against rehearsal contract ([8262197](https://github.com/k4lantar4/remnabot/commit/8262197f9c8c7cc718cd066559f43adf040c9efe))
* **M4-T3:** alembic 0111 remnawave_id and boot extras ([6fe283f](https://github.com/k4lantar4/remnabot/commit/6fe283faecf1fbf86558a9a5a5ac6aa7de525cf9))
* **M4-T5:** persist_identity seam for numeric panel id ([7ef119a](https://github.com/k4lantar4/remnabot/commit/7ef119aebea8abb37046628870755810a7e4dc9d))
* **M4-T6:** stable-key remnawave_id backfill (G6) ([bd20193](https://github.com/k4lantar4/remnabot/commit/bd2019397be21be2e78b9ef4d1cc557ba7a7bea6))
* **M4-T7:** port C2C, FA fallback, Toman, wholesale ([8173cb2](https://github.com/k4lantar4/remnabot/commit/8173cb28df5beeed135b1585d025be5e3bf59eed))
* **menu:** кнопка «Меню» Telegram открывает веб-кабинет (WebApp) ([c7e2087](https://github.com/k4lantar4/remnabot/commit/c7e208750efd6a2cb43c6c6607cf84d3109f595c))
* **mulenpay:** передавать контакт клиента в поле client ([b4a062a](https://github.com/k4lantar4/remnabot/commit/b4a062ab9395614102d8d0fb8177d230a5ac12fd))
* **nalogo:** доставка чека на почту, когда Telegram недоступен ([3c047ed](https://github.com/k4lantar4/remnabot/commit/3c047edb0b884f6bf5ade8e9bb3bc9c1af382609))
* **nalogo:** доставка чека файлом — lknpd недоступен клиентам через VPN ([cbccaaf](https://github.com/k4lantar4/remnabot/commit/cbccaaf7ac225d3ba597da1d023da994c6fb00a2))
* **nalogo:** имя и почта копируются по тапу + HTML-экранирование ([078493a](https://github.com/k4lantar4/remnabot/commit/078493a9ba7440b404a55010aef20c8b5418f64d))
* **nalogo:** отправка чека пользователю + дублирование в админ-топик ([3229b5a](https://github.com/k4lantar4/remnabot/commit/3229b5aaaecf8cda875a20fafdc1cb1d393d33ba))
* **nalogo:** подробный блок получателя в админ-уведомлении о чеке ([0490ffb](https://github.com/k4lantar4/remnabot/commit/0490ffbed7354c6bb8e1f26d9b6c25565e94caea))
* **nalogo:** порядок полей в блоке получателя (ID, имя, username, почта) ([2ef6963](https://github.com/k4lantar4/remnabot/commit/2ef6963a70b266714440cd76749e7d757126b92b))
* **payments:** интеграция платёжной системы cisPay ([392722f](https://github.com/k4lantar4/remnabot/commit/392722f9bf69c459844ea0c2bf4075026f8e2bbb))
* **payments:** флаг YOOKASSA_SKIP_IP_CHECK с fail-closed проверкой платежа через API ([2ac5299](https://github.com/k4lantar4/remnabot/commit/2ac52992f04a004dc61227b14171935243f31963))
* **platega:** CRUD рекуррентных подписок ([9cf2aa3](https://github.com/k4lantar4/remnabot/commit/9cf2aa3a546e639369077dfb30ab65bbcb2e5c89))
* **platega:** WS-события sbp_recurring.* для кабинета ([f34431a](https://github.com/k4lantar4/remnabot/commit/f34431a46b00dc2fc1169f9ede4a43aee6405ac9))
* **platega:** админка кабинета — статус и отмена СБП-автооплаты ([135771e](https://github.com/k4lantar4/remnabot/commit/135771e02e05761b72961a97d7364e72b6706177))
* **platega:** бот-флоу автопродления через СБП ([a69d233](https://github.com/k4lantar4/remnabot/commit/a69d233886874883b25b89f6d3230db41a3b61f4))
* **platega:** ветка подписочных коллбеков в /platega-webhook ([9d13c4e](https://github.com/k4lantar4/remnabot/commit/9d13c4ec5069e5571212ad967028d8ccaf29e998))
* **platega:** гейт PLATEGA_RECURRENT_ENABLED ([23ba645](https://github.com/k4lantar4/remnabot/commit/23ba6455fd43c69075fa8540b0f86f0358c7ac3b))
* **platega:** кабинетные эндпоинты СБП-автопродления (юзер) ([19862a2](https://github.com/k4lantar4/remnabot/commit/19862a298e6233587de9351abf862f3040dfae6e))
* **platega:** методы подписок в PlategaService (create/get/list/cancel) ([27c8fac](https://github.com/k4lantar4/remnabot/commit/27c8fac35a5e2edf88db0723520cc2323cd0118d))
* **platega:** модель platega_subscriptions + миграция ([5c9580a](https://github.com/k4lantar4/remnabot/commit/5c9580a8e0b2ce06199419bae93b648a182a7187))
* **platega:** обработчик коллбеков подписки (продление, идемпотентность, статусы) ([5a33a9e](https://github.com/k4lantar4/remnabot/commit/5a33a9e703137240aa3fc75173840bc861420ad8))
* **platega:** отмена СБП-автооплаты при удалении/отзыве подписки ([2593424](https://github.com/k4lantar4/remnabot/commit/2593424901a1653a7ea264eff43475bfea6e9694))
* **platega:** отмена СБП-подписки + best-effort хелпер по подписке ([4763cbe](https://github.com/k4lantar4/remnabot/commit/4763cbe1da6e8d41a15f4880ff36efa436246219))
* **platega:** реконсилятор СБП-подписок в monitoring-цикле ([1cf5212](https://github.com/k4lantar4/remnabot/commit/1cf5212e085b0267179b3663366e4eab7f9761f0))
* **platega:** СБП-оформление подписки — альтернатива оплате с баланса ([43d81c8](https://github.com/k4lantar4/remnabot/commit/43d81c86c3d2afe7695af18ad72d072e13229393))
* **platega:** создание СБП-подписки + выключение balance-autopay ([e701cad](https://github.com/k4lantar4/remnabot/commit/e701cad459a1a3204a5546d829c3b5accb0d1b8f))
* **platega:** чистая логика каденса рекуррентных СБП-подписок ([8200847](https://github.com/k4lantar4/remnabot/commit/8200847d86de32989df5490a4581a1fffd7c8029))
* **promo-offers:** охват сегментов и прогресс доставки промопредложений ([5e4548b](https://github.com/k4lantar4/remnabot/commit/5e4548b3d3dcee63db42f9b6a57a8daea274a290))
* **promocodes:** трафик в наборе бонусов промокода ([93f5bff](https://github.com/k4lantar4/remnabot/commit/93f5bff49691847284e8d8bb12650bffaef92084))
* purchase and share gifts from balance ([7496ed5](https://github.com/k4lantar4/remnabot/commit/7496ed5143d34197942340bcd777dca1fa127c20))
* **quick-amounts:** возможность отключить кнопки быстрых сумм пополнения ([b1f9be6](https://github.com/k4lantar4/remnabot/commit/b1f9be6da15a25c95de1a4f729a1e8f9b844a93c))
* **referral:** a level is unlocked by referral count, and says so ([ea3b95e](https://github.com/k4lantar4/remnabot/commit/ea3b95e29b4d79ac7f2a78c16deb3e898f7ead27))
* **referral:** admin editor for reward levels ([0e3b051](https://github.com/k4lantar4/remnabot/commit/0e3b051cfb967eadc776da274bc7b71b11a9846a))
* **referral:** expose levels and day rewards through the cabinet API ([fbd20bb](https://github.com/k4lantar4/remnabot/commit/fbd20bb45fd55d31fe85b9912e7957eabf40f6f7))
* **referral:** multi-level rewards in money and/or subscription days ([c252439](https://github.com/k4lantar4/remnabot/commit/c252439a9e711243c06d31e3a5ad283151bc4f96))
* **referral:** set the chain depth from the level editor, up to ten levels ([5b14a65](https://github.com/k4lantar4/remnabot/commit/5b14a6563c1c8de8d8f6c43274b17e20044efd67))
* **referral:** show subscription-day rewards across statistics and the user screen ([0fb08fa](https://github.com/k4lantar4/remnabot/commit/0fb08fabae14c1a710f72110cab4efcd37d0a72c))
* **referral:** выбор награды двоичный — деньги или дни ([f733524](https://github.com/k4lantar4/remnabot/commit/f7335241ab5ff1bbc774824923287eecd1abb10a))
* **referral:** называть ступени уровнями и отдавать их кабинету по частям ([61c8d66](https://github.com/k4lantar4/remnabot/commit/61c8d66937cffae8b20905c74f5efa62e5647695))
* **referral:** показывать суммы сторон и спрашивать подписку только под дни ([b7dc6d7](https://github.com/k4lantar4/remnabot/commit/b7dc6d7c779331fbe4b28a8826f2dc7581b5855e))
* **referral:** пользователь выбирает вид награды и подписку для дней ([85c17b6](https://github.com/k4lantar4/remnabot/commit/85c17b6f624a92b2288e38877379aa248a6f264c))
* **referral:** режим рангов — один уровень за число рефералов ([dedf9fb](https://github.com/k4lantar4/remnabot/commit/dedf9fbacb0fb5ca63e2b8a687b513022e48a561))
* **remnawave:** бэкфил панельной идентичности ([b97e5f6](https://github.com/k4lantar4/remnabot/commit/b97e5f6bbfa7bf792b06f4ac181e214cec5da96c))
* **remnawave:** клиент API под 3.0.0 ([c763514](https://github.com/k4lantar4/remnabot/commit/c763514324c45aff3193631cc4c344873c3ebc55))
* **remnawave:** проксировать GeoCheck ноды из панели 3.3.0 в кабинет ([134d8e4](https://github.com/k4lantar4/remnabot/commit/134d8e4ef828d138bc74a4608af9ee64c15e6e98))
* **remnawave:** сервисный слой на числовую идентичность ([6da10bc](https://github.com/k4lantar4/remnabot/commit/6da10bcc94e2dbf37e7d646d48e3a3a018a60c4d))
* **remnawave:** транслитерация кириллицы в username пользователя ([35383c2](https://github.com/k4lantar4/remnabot/commit/35383c206aa0d2bb8e86c3745a96ed8f80666e4a)), closes [#1659](https://github.com/k4lantar4/remnabot/issues/1659)
* **remnawave:** хендлеры, миддлвари и Web API под 3.0.0 ([c897d38](https://github.com/k4lantar4/remnabot/commit/c897d383ceb0177babc5f38ecca368899228bc0d))
* resume gift checkout after balance topup ([3cf405b](https://github.com/k4lantar4/remnabot/commit/3cf405b483ea947a77f2a27667171ce6c47cc358))
* **rich:** настройка вывода кнопок внутри полотна rich-сообщения (Bot API 10.3) ([fbe3594](https://github.com/k4lantar4/remnabot/commit/fbe3594964c6c606eacac8798d1d0fb3f5457b6c))
* **rich:** пользовательские уведомления rich-сообщением с кнопками внутри ([497064e](https://github.com/k4lantar4/remnabot/commit/497064eaa1652c6c182c22ce629fe438af6f71bc))
* **rich:** уведомления в стиле rich-меню и охват рассылок ([01d8f2c](https://github.com/k4lantar4/remnabot/commit/01d8f2cf2691f3283480fbc43f5aa635140cd1f5))
* **rich:** уведомления мониторинга тоже rich — логотип не теряется ([9ebc17d](https://github.com/k4lantar4/remnabot/commit/9ebc17dd8b4a08d278684cd1e0c7780073a47b67))
* **sales:** assign account_sequence on new paid subscriptions ([f2808ad](https://github.com/k4lantar4/remnabot/commit/f2808ad7ac6c3905e16f3d7d3c962becec62c212))
* **sales:** expose panel_username and search on cabinet subscription list ([882771d](https://github.com/k4lantar4/remnabot/commit/882771dc2d59f6bb4125fda93782ce563120ab38))
* **sales:** keep menu_buy on /start for multi-tariff and clear the renew pin ([8688640](https://github.com/k4lantar4/remnabot/commit/8688640dfcfa609853a0f94ed02eb2251d85dd40))
* **sales:** map panel_username and cache it beside persist_identity ([93085ed](https://github.com/k4lantar4/remnabot/commit/93085eddce0e12bc04fde4981035f74f8f97d670))
* show payment methods directly on extend insufficient-balance screen ([45f81a8](https://github.com/k4lantar4/remnabot/commit/45f81a89f3983441e391ebe699f0dfc34ce5bbb4))
* show payment methods directly on extend insufficient-balance screen ([00c66cf](https://github.com/k4lantar4/remnabot/commit/00c66cfb71743dfd2beb34f3a205b40a8f7c9331))
* skip tariff selection screen when only one tariff is available ([5c74099](https://github.com/k4lantar4/remnabot/commit/5c7409940cf975ea4748519cf4d54bb265702209))
* skip tariff selection screen when only one tariff is available ([935dbe3](https://github.com/k4lantar4/remnabot/commit/935dbe3825d48b0b97395bf10127e59954223708))
* sort user list by soonest subscription expiry ([e3713ce](https://github.com/k4lantar4/remnabot/commit/e3713ce9710dfa8d3fbfc1abf10b034378fd8978))
* sort user list by soonest subscription expiry ([f69a670](https://github.com/k4lantar4/remnabot/commit/f69a67014027efe0acb7779ce40371f0d5330866))
* **start:** видео в стартовом меню бота, загрузка из кабинета ([524960c](https://github.com/k4lantar4/remnabot/commit/524960c3561953df2f18108b224dfef5292ff811))
* **support-ws:** bridge core + message.created from ticket.message_added ([e54e1e3](https://github.com/k4lantar4/remnabot/commit/e54e1e3009fa33d7b4a8b54a7fbcc23831b34009))
* **support-ws:** bridge ticket.created and ticket.status_changed mappings ([2ff76f3](https://github.com/k4lantar4/remnabot/commit/2ff76f35970a766cdc5d6cb497455410874917d8))
* **support-ws:** emit ticket events from cabinet/mini-app routes for bridge ([d65d9fb](https://github.com/k4lantar4/remnabot/commit/d65d9fb059d0f59e2812e43f28ca04988d138a68))
* **support-ws:** register event bridge at app startup ([8d80230](https://github.com/k4lantar4/remnabot/commit/8d80230a8db50e9b3f668c172696e3ad7e462c04))
* **tariff:** expose custom traffic settings in Telegram admin ([d75cbfe](https://github.com/k4lantar4/remnabot/commit/d75cbfec5820e051fc6bacee9a67514b0945b167))
* **tariff:** прямая оплата тарифа без отдельного шага пополнения баланса ([a060575](https://github.com/k4lantar4/remnabot/commit/a06057504de86285273e801bc411879b964a4a36))
* unify public gift codes ([28b313c](https://github.com/k4lantar4/remnabot/commit/28b313c8d8b9514a7427c63951bb7e7005a410ac))
* **webapi:** эндпоинт ручного пополнения баланса с идемпотентностью ([cd9811c](https://github.com/k4lantar4/remnabot/commit/cd9811c18f679047a30c6c304ca99ab89f386cc6))
* WEBHOOK_SUB_EXPIRING + переводы zh/ua для webhook-писем + тесты ([38771d3](https://github.com/k4lantar4/remnabot/commit/38771d3e9fdb727aa5b5a5b25e09ae4ce655fd4e))
* zh/ua для winback-писем, честный PAYMENT_RECEIVED для автосписания, тесты ([a37fad2](https://github.com/k4lantar4/remnabot/commit/a37fad271a411e685e66f703dd33c5a987ed0008))


### Bug Fixes

* address final review findings for gift security and telemetry ([ad18226](https://github.com/k4lantar4/remnabot/commit/ad18226faf828716b922b1df9444f6c4e2b6b754))
* **admin:** device_limit = 0 в админке тоже показывать безлимитом ([8e1b2cc](https://github.com/k4lantar4/remnabot/commit/8e1b2cc9af70f3475466d6e8ed4a8c846b2ebdfb))
* **admin:** pin selected subscription panel identity ([88572ca](https://github.com/k4lantar4/remnabot/commit/88572caf9b2f1c2a9f95343923277f1bb190b531))
* **admin:** prevent selected subscription UUID fallback ([0f9298c](https://github.com/k4lantar4/remnabot/commit/0f9298c63b65aee767e1a869dd5045a17f82aa79))
* **admin:** validate supplied subscription ownership ([da87a8d](https://github.com/k4lantar4/remnabot/commit/da87a8de143a1525188fc849f9a89caf566010ce))
* **admin:** запретить блокировку аккаунтов из ADMIN_IDS/ADMIN_EMAILS ([15613ee](https://github.com/k4lantar4/remnabot/commit/15613ee34c28421ad07c2a9df8d472e01cdf9657))
* **admin:** лог при пропуске синка панели у подписки без UUID ([3d77bc2](https://github.com/k4lantar4/remnabot/commit/3d77bc20a621702ec2f0f3bd4f21a1f5a4a80a9e))
* **admin:** отмена рекуррента Lava при сбросе выбранной подписки ([2f2006a](https://github.com/k4lantar4/remnabot/commit/2f2006a5d08289ccfb3c606d0cdb702ccd369ea7))
* **admin:** платёжные провайдеры в разделе «Платежные системы» ([a53f9ad](https://github.com/k4lantar4/remnabot/commit/a53f9ad2bc13f761a51a43b36bab5ffb5356781a))
* align BanHammer notification contract ([e84a9b0](https://github.com/k4lantar4/remnabot/commit/e84a9b001a0a8d2502466a13f93e7da1d7e30c5d))
* **auth:** выровнять привязку подарка в двух путях завершения регистрации ([96ad208](https://github.com/k4lantar4/remnabot/commit/96ad2084969c28250026b189b25b99ca61a33f5e))
* **auth:** закрыть находки ревью invite-only ([830c484](https://github.com/k4lantar4/remnabot/commit/830c484fc89c938907c6e3345b3d2e13fb6b43ee))
* **auth:** не пускать регистрацию на алиасе уже занятого ящика ([c290a17](https://github.com/k4lantar4/remnabot/commit/c290a17bf21ad4e8074a49117187282156df98b3))
* **auth:** не пускать регистрацию на алиасе уже занятого ящика ([8fcdefd](https://github.com/k4lantar4/remnabot/commit/8fcdefd99896c90855000c7224514634ec1ad446))
* **auth:** починить поиск двойника по ящику на SQLite и не прятать чужой аккаунт ([b4fdc54](https://github.com/k4lantar4/remnabot/commit/b4fdc54113a4728d664480a0e12a37ea568ddf9a))
* auto-purchase silently skipped after top-up due to updated_at race guard ([ad3e9cf](https://github.com/k4lantar4/remnabot/commit/ad3e9cf5353e58df5d29e2fc9e34b278fc06f8b7))
* back button leads to main menu when tariff selection was skipped ([a6e5c5a](https://github.com/k4lantar4/remnabot/commit/a6e5c5a227fa1c6f5d79e00d1801a66d05756771))
* **bans:** уважать общий выключатель уведомлений в типизированных банах ([927790f](https://github.com/k4lantar4/remnabot/commit/927790fd4d674e32a4824c9778801d63bb360393))
* build secure shareable gift links ([ce7dd46](https://github.com/k4lantar4/remnabot/commit/ce7dd461618afdb6acdb403bc98832f996e3be5b))
* **cabinet:** 'keep' во внешнем скваде сравнивать без учёта регистра ([fbabcd0](https://github.com/k4lantar4/remnabot/commit/fbabcd0f14be3df7a818019ecf6b26bf81e1b9c9))
* **cabinet:** id админа снимаем до цикла массового действия ([9fba46f](https://github.com/k4lantar4/remnabot/commit/9fba46f4e4820d6aacd3a459ff2bf6bfdab1a228))
* **cabinet:** закрыть находки ревью раздела grace-доступа ([58472a3](https://github.com/k4lantar4/remnabot/commit/58472a3fa740f8d19d1e8317b676471af28445c5))
* **cabinet:** не отдавать пустую строку вместо null в /info/service ([1707660](https://github.com/k4lantar4/remnabot/commit/1707660636fdf86547a891064ad9ec4f0f6bfafc))
* **cabinet:** отдавать в /info/service реальные настройки ([0ba8fa5](https://github.com/k4lantar4/remnabot/commit/0ba8fa56bbf778e79b4cec52cde46dcc38d5e4a4))
* **cabinet:** отдавать в /info/service реальные настройки ([3329ec3](https://github.com/k4lantar4/remnabot/commit/3329ec33cf824cc8568f09f01a709be6cba9b3aa))
* **cabinet:** удаление подписки адресует панельный аккаунт по режиму ([1feef2c](https://github.com/k4lantar4/remnabot/commit/1feef2c55835de2256eb114d3814417aac23d38f))
* **cabinet:** удаление подписки в массовых действиях падало MissingGreenlet ([c99fd54](https://github.com/k4lantar4/remnabot/commit/c99fd544fa822eec7190c8461a1179b984d2b915))
* **channel:** не слать админам traceback на заблокировавших бота ([d91caee](https://github.com/k4lantar4/remnabot/commit/d91caeeee24d6be463c5f0efb502f10e7016cac2))
* **ci:** lowercase-референс образа для Trivy-скана ([795c7be](https://github.com/k4lantar4/remnabot/commit/795c7be735e6aaa61d2689d97c815346a090ae7b))
* clean up duplicate exports in subscription handlers ([0ff752c](https://github.com/k4lantar4/remnabot/commit/0ff752c881f605048b11bffd89c15f0ec99bd3d2))
* **config:** закомментировать ключи grace в .env.example ([c53540f](https://github.com/k4lantar4/remnabot/commit/c53540fc463503b9abf41145f4841e01863596cd))
* **currency:** charge catalog prices in Toman on tariff purchase ([046bd24](https://github.com/k4lantar4/remnabot/commit/046bd24ae1a34a4508894a7721d4e1cc56072fa2))
* **day1:** clear partner note prompt keyboard and add cancel ([0f69791](https://github.com/k4lantar4/remnabot/commit/0f69791a2e70ef5762916444936bf46afc7fdee9))
* **day1:** commit partner purchase_note before Remnawave sync ([17d156e](https://github.com/k4lantar4/remnabot/commit/17d156e7e29d1f27127ff49459c174eaeb3d0105))
* **day1:** keep user-paused subs with active list order ([e716cb8](https://github.com/k4lantar4/remnabot/commit/e716cb83838a4370dd8fb47127a4c28ff21e6221))
* **day1:** partner brand identity for 4-digit serials ([d09af66](https://github.com/k4lantar4/remnabot/commit/d09af6698a2fc4fdb4619676eb1a5b4533a6054a))
* **day1:** pause confirm + refresh real user_disabled status ([57b4407](https://github.com/k4lantar4/remnabot/commit/57b440736ed646e3b37c13be29f0e793d4d793f6))
* **day1:** re-render My Subs list after search and escape query ([ea3fa12](https://github.com/k4lantar4/remnabot/commit/ea3fa12efe71c32586893bf87f64815f46ff3efa))
* **day1:** reactivate before Remnawave create on pause resume ([114886f](https://github.com/k4lantar4/remnabot/commit/114886fb0636ca118adf62d5d996d9e85bb6a094))
* **day1:** rollback pause on panel failure and show error toasts ([b96e8b5](https://github.com/k4lantar4/remnabot/commit/b96e8b5db3d8a53305b39e85c8e79475ebe77708))
* **day1:** stop expire_all on sm: detail (MissingGreenlet) ([53a9a39](https://github.com/k4lantar4/remnabot/commit/53a9a39ffcb86dffa3dd1d391fe885d524e9763a))
* **email:** use notify_autopay_success wrapper so email shows the new expiry date ([973cc90](https://github.com/k4lantar4/remnabot/commit/973cc90640cd9208487fe23c564d403396d0d9a0))
* **email:** не ждать таймаут SMTP на каждом адресе рассылки ([b934713](https://github.com/k4lantar4/remnabot/commit/b9347138cb9391857cf7791bd1108e0749cdc538))
* **email:** отписку применяет только POST + границы токена ([091e2ee](https://github.com/k4lantar4/remnabot/commit/091e2ee95fd4709f26b521bbc4a05a750a65eb65))
* **gift:** address code review findings for gift subscription feature ([e22dd8c](https://github.com/k4lantar4/remnabot/commit/e22dd8ce80f4776d6f9f36230d85c81272d46cdb))
* **gift:** address combined review findings for gift features ([824b6a0](https://github.com/k4lantar4/remnabot/commit/824b6a0b2ba7ea0f02ea41c404ce34fba714bd53))
* **gift:** harden purchase recovery and claim presentation ([8464299](https://github.com/k4lantar4/remnabot/commit/8464299dc95659dad7cb499c43c4176e72fdc596))
* **grace:** реализовать обещанное 'keep' и починить тест внешнего сквада ([40459b7](https://github.com/k4lantar4/remnabot/commit/40459b7cd6293f65d6590c7aed5f8327bfcb5d27))
* **grace:** сессия без панельного id чинится при чтении, а не живёт вечно ([5116848](https://github.com/k4lantar4/remnabot/commit/51168487da3f51a256e59abe9655fcc8ebee0364))
* harden gift purchase recovery flows ([f03fa56](https://github.com/k4lantar4/remnabot/commit/f03fa56671c09aea8fccbc9366d5727c323e8f78))
* **i18n:** исправление ошибок перевода в fa/ua/zh локалях ([2cc0f36](https://github.com/k4lantar4/remnabot/commit/2cc0f36dd89c68ee8499929ede93020932332c40))
* **lava:** взаимоисключение с Platega + сдвиг списания при ручном продлении ([da84ed1](https://github.com/k4lantar4/remnabot/commit/da84ed101e539031db5ad8178e6d7b8e5139ce6d))
* **lava:** закрыты находки адверсариального ревью рекуррента ([94e3fcd](https://github.com/k4lantar4/remnabot/commit/94e3fcd3147a31520e7cf51ce2a47ef0a95421d2))
* **lava:** имя провайдера в правой части «через …» вместо имени метода ([df92f68](https://github.com/k4lantar4/remnabot/commit/df92f68fc5d5ca099071b8d6310b3d7388db503a))
* **logging:** убрать зарезервированный kwarg event= из вызовов structlog ([4d76382](https://github.com/k4lantar4/remnabot/commit/4d76382b7756e956dc420ff0a7dfc6f970b48d10))
* **M6-T4:** C2C missing amount uses Toman not catalog subtract ([3b726b1](https://github.com/k4lantar4/remnabot/commit/3b726b1968b0f00f6bd6144d2122aaa793262334))
* **M6-T4:** C2C success notify accepts cart_autopurchase_failed ([05f40c8](https://github.com/k4lantar4/remnabot/commit/05f40c8ac9517dc555ab468cec90d856a6b103f9))
* **M6-T4:** main-menu balance uses Toman 1:1 not catalog ÷100 ([9cf6840](https://github.com/k4lantar4/remnabot/commit/9cf68409c49f438afff9097fdd3c92505b9955aa))
* **M6-T5:** cabinet balance JSON uses Toman 1:1 helpers ([0cb0cdb](https://github.com/k4lantar4/remnabot/commit/0cb0cdb11ed4b230def2e40ddaf94df30a0665c1))
* **M6-T5:** paginate My Subscriptions for photo-caption limit ([cfb357f](https://github.com/k4lantar4/remnabot/commit/cfb357f8cc506ff2ceb5a354f9b230279e250b32))
* **maintenance:** техработы включались сами после каждого перезапуска ([44c7269](https://github.com/k4lantar4/remnabot/commit/44c7269c257c3defd6a12fe9275c6d0a87757c05))
* make BroadcastResponse.message_text Optional[str] ([9a23bc3](https://github.com/k4lantar4/remnabot/commit/9a23bc371218c5866fedc53f219d3b3de2ec368c)), closes [#3151](https://github.com/k4lantar4/remnabot/issues/3151)
* **menu:** приводить HTML страниц к разметке, которую понимает Telegram ([5ce73e3](https://github.com/k4lantar4/remnabot/commit/5ce73e326e346b7cf580ad261def38d39f8e15ca))
* **migrations:** перенумеровать миграцию кампании в 0105 ([79b17f0](https://github.com/k4lantar4/remnabot/commit/79b17f033d5088ae36b9aea32aae2b83ba1aafb8))
* **migrations:** развести номер миграции гостевых покупок с 0105 ([d4f529b](https://github.com/k4lantar4/remnabot/commit/d4f529b70d624c209b51d37e03150a187e790597))
* **mulenpay:** слать в client только подтверждённый email и не блокировать оплату ([9ce44f9](https://github.com/k4lantar4/remnabot/commit/9ce44f978a6cee4c147caf3561568bd0e10b4006))
* **nalogo:** print_url строил ссылку на чек без /v1 ([a472d11](https://github.com/k4lantar4/remnabot/commit/a472d11279f6fba23d7bdc771ced30a747aaa31f))
* **nalogo:** доставлять чек покупателю после ручной пересылки из админки ([fa25d70](https://github.com/k4lantar4/remnabot/commit/fa25d701a2227829f7d5ac087af77a68a31d145b))
* **nalogo:** дочитывать печатную форму чека до конца ([7dcd18e](https://github.com/k4lantar4/remnabot/commit/7dcd18ec8a27a855b644ea1eab7d0b9989204f57))
* **nalogo:** не терять чек, если Telegram отверг файл, и не слать HTML как чек ([abde46c](https://github.com/k4lantar4/remnabot/commit/abde46cbe501c5d2712f2aaf2b2f61fc09085a5d))
* **nalogo:** ссылка на чек — добавлен /v1 (баг библиотечного print_url) ([a547f5c](https://github.com/k4lantar4/remnabot/commit/a547f5cb5f6f83aa5f73ad24fec9df0b307f5a4d))
* **nalogo:** чек по подарочной покупке — адресат покупатель, а не одаряемый ([3a0a157](https://github.com/k4lantar4/remnabot/commit/3a0a157f35029c8c2e57b013147c74f33339059b))
* **notifications:** MissingGreenlet при уведомлении о регистрации по кампании ([0f1beff](https://github.com/k4lantar4/remnabot/commit/0f1beff51b284bae0183bb37000b860e82b4ee4e))
* **notifications:** кнопка продления в мультитарифе вела в бота, а не в кабинет ([f0d0cec](https://github.com/k4lantar4/remnabot/commit/f0d0cec1901ab853785dc082665a698a7a466e09))
* **notifications:** не отправлять отключённые уведомления пользователям ([22370a8](https://github.com/k4lantar4/remnabot/commit/22370a804114e9514d28b47ca3b55635e12b07b1))
* **oauth:** per-origin redirect_uri so OAuth login works on mirror domains ([1f873f9](https://github.com/k4lantar4/remnabot/commit/1f873f983476f34c6ce21ad407eb0de4756fd7fe))
* **oauth:** привязка провайдера тоже возвращается на домен запроса ([d99ab15](https://github.com/k4lantar4/remnabot/commit/d99ab15c9957d5e24d4ea068e34e8b0a89632cd8))
* **payments:** дренаж фоновой обработки вебхуков при остановке ([531060e](https://github.com/k4lantar4/remnabot/commit/531060e836fd25a05cfc0423cadf59f6321cd960))
* **payments:** не терять вебхуки платёжек, выключенных на момент старта ([67532db](https://github.com/k4lantar4/remnabot/commit/67532dbd50c97fc5f97b450a53a0d0c72eb64bc6))
* **platega:** actionable-ошибка при отказе создания СБП-подписки ([0864a95](https://github.com/k4lantar4/remnabot/commit/0864a95ec65f90cdcf60d2af9ff2265b3be51e0d))
* **platega:** side-effects после СБП-списания + защита от пустого charge Id и пропавшей подписки ([ee295c6](https://github.com/k4lantar4/remnabot/commit/ee295c6a8dcd648f5c64b1aaea61fed238eee0d5))
* **platega:** аудит-фиксы СБП-автопродления — money-safety и полнота отмен ([ccc2049](https://github.com/k4lantar4/remnabot/commit/ccc2049c7d15dda6779ce6f74a6b807459275a72))
* **platega:** гонка конкурентного enable (D5) и outage-vs-404 в reconciler (D4) ([8243d39](https://github.com/k4lantar4/remnabot/commit/8243d3924e034e04ba83b61086a7e10a7ca02bdf))
* **platega:** идемпотентность создания СБП-подписки (не плодить дубли и двойные списания) ([132ef4e](https://github.com/k4lantar4/remnabot/commit/132ef4e19f0ba1f24fd4958e88d2a9ceb65945e0))
* **platega:** распознавать camelCase-коллбеки рекуррентной СБП-подписки ([4123ee8](https://github.com/k4lantar4/remnabot/commit/4123ee8268dbe24fd5dac330b1d2f9499275aa67))
* **platega:** санитайзить description подписки под 64-байтный лимит Platega ([f7a6f5b](https://github.com/k4lantar4/remnabot/commit/f7a6f5b624856bed742373ea123648c58e9e2642))
* **platega:** СБП-автопродление доступно для суточных тарифов + гард на триал ([9fe42e7](https://github.com/k4lantar4/remnabot/commit/9fe42e795c93cb26f75ca95e919adf983ac760c8))
* **platega:** синк панели после списания + обратное взаимоисключение + отмена на пропущенных путях удаления ([57ad9b7](https://github.com/k4lantar4/remnabot/commit/57ad9b746e53d82c8641b7c0ee47eaa210993c21))
* **platega:** три P2 из ревью релизного PR [#3111](https://github.com/k4lantar4/remnabot/issues/3111) ([64feac0](https://github.com/k4lantar4/remnabot/commit/64feac0aa8e5da90da38797a4d834fbcb350c2e2))
* **pricing:** корректная цена за месяц для коротких и некратных периодов ([9b172b2](https://github.com/k4lantar4/remnabot/commit/9b172b2d7af1ee33ac132a9341c9f967a47ed7a2))
* **promo-offers:** счётчик сегмента expired — живая ветка вместо мёртвой ([d93762f](https://github.com/k4lantar4/remnabot/commit/d93762ff0bcbd4834afc3f3bca858e63f53e08cd))
* **promocode:** MissingGreenlet при отказе активации — rollback экспирировал db_user хендлера ([d0c1d5d](https://github.com/k4lantar4/remnabot/commit/d0c1d5dec2e828222d84d39d0e7aad83188abc5e))
* **promocodes:** код с одним трафиком не сгорает на безлимитной подписке ([7254930](https://github.com/k4lantar4/remnabot/commit/72549306956a58aebff84111b8e0a84072675397))
* **promocodes:** трафик доезжает до строки, а начисление возвращает доступ ([0d70155](https://github.com/k4lantar4/remnabot/commit/0d701557893e0bfd4d0d6f9797b63cfe6008df52))
* **recurrent:** цена автопродления учитывает докупки устройств и трафика ([85344c6](https://github.com/k4lantar4/remnabot/commit/85344c663e7c5f5b99761d8ad06aebdac7916a4f))
* **referral:** close five traps in the bot level editor ([f7f4e65](https://github.com/k4lantar4/remnabot/commit/f7f4e65d51dd51ac03f3807134ca9b9216cb9965))
* **referral:** close the hazards an adversarial audit found in the levels scheme ([72ae99b](https://github.com/k4lantar4/remnabot/commit/72ae99bc4483c639b3129f0726a59f03f5f224d9))
* **referral:** close what an adversarial review of the levels feature found ([28aaf80](https://github.com/k4lantar4/remnabot/commit/28aaf804eb630211ad74f26cee8d987904ddaa50))
* **referral:** close what an execution audit found in day granting and the editor ([da1a820](https://github.com/k4lantar4/remnabot/commit/da1a82082ce0777e0ab4edb45123ef734306e60d))
* **referral:** close what the UX review found in the bot ([c08d42b](https://github.com/k4lantar4/remnabot/commit/c08d42b9cf08e96b3e024b2b24d55f610e928b0c))
* **referral:** finish the level surface — localization, depth, remaining totals ([223a8dd](https://github.com/k4lantar4/remnabot/commit/223a8ddcddeb78431ff84d100c3d4196684b105a))
* **referral:** make a fresh install and an upgraded one reach the same schema ([01190d7](https://github.com/k4lantar4/remnabot/commit/01190d70a74b5e025933d14ce7f0d5ebe75b86f7))
* **referral:** repair a leaked mutation and close a verification pass ([ecdaa68](https://github.com/k4lantar4/remnabot/commit/ecdaa681f416e60e76362238741bfcbc0d42a0ed))
* **referral:** scope the payment cap to its level, and import the right percent ([6e4556c](https://github.com/k4lantar4/remnabot/commit/6e4556c5e94caacc2886a710bf85bf18a11be989))
* **referral:** send day rewards to the paid subscription, not whichever comes first ([9bce186](https://github.com/k4lantar4/remnabot/commit/9bce18618f6ac8f0df20cd86bea2606190d9fd40))
* **referral:** stop dropping tariff-targeted days for users subscribed elsewhere ([1670d7f](https://github.com/k4lantar4/remnabot/commit/1670d7fca66aa693f0c9a3fa74d36e563eaa5229))
* **referral:** вернуть реферальным настройкам редактируемость из админки ([8112f3c](https://github.com/k4lantar4/remnabot/commit/8112f3c66dc3de39d8d78350644f674a7c287e87))
* **referral:** закрыть остальное, что нашла проверка фичи ([104e595](https://github.com/k4lantar4/remnabot/commit/104e595f7494ee2673338eb4c39c9d63340c2134))
* **referral:** не обещать процент, который не может начислиться, и вернуть тариф в миниапп ([3a8273e](https://github.com/k4lantar4/remnabot/commit/3a8273e56397061c4624c823d4eacae2b612cd29))
* **referral:** не оставлять взведённым ввод глубины и не врать про процент ([889b5fd](https://github.com/k4lantar4/remnabot/commit/889b5fd2ef2b61eff7dee37459ae568bb4e4f3b7))
* **referral:** не терять ответ на callback и не врать про процент партнёра ([40f746e](https://github.com/k4lantar4/remnabot/commit/40f746e1432fe4654e63dde4c7b39ac7a8ec610f))
* **referral:** применять лимит выплат к начислению той же секунды ([43140f0](https://github.com/k4lantar4/remnabot/commit/43140f09584f0140d80c64ff501b9f316b380eda))
* **remnawave:** grace-сессия строки-донора не теряет идентичность ([dc09e78](https://github.com/k4lantar4/remnabot/commit/dc09e78077d00c02b3dc3e16a4e846bcf1cbed30))
* **remnawave:** бэкфил не блокируется одной парой и отдаёт id живой строке ([5cd3adb](https://github.com/k4lantar4/remnabot/commit/5cd3adb5bd856ca54d984bb4f9f59ce33a097b0d))
* **remnawave:** бэкфил не откатывался целиком на single-tariff ([d461784](https://github.com/k4lantar4/remnabot/commit/d461784f3c70cb58c7dd11fc9c51b60be0190ae8))
* **remnawave:** бэкфилл падал на старте и брал не тот режим ([deeb24f](https://github.com/k4lantar4/remnabot/commit/deeb24fbcdd235f63892b50d2ca478b2c6ac6325))
* **remnawave:** бэкфилл привязывал чужой аккаунт, создание падало на индексе ([98e63b0](https://github.com/k4lantar4/remnabot/commit/98e63b07b5c8e8c562c1e96936049f057257d2d8))
* **remnawave:** вебхук не проверял соседей, и подписи тестов врали ([70d35c1](https://github.com/k4lantar4/remnabot/commit/70d35c1afee123938ce833688120dc2397855d98))
* **remnawave:** защита от противоречивых uuid не работала на первом прогоне ([928ce20](https://github.com/k4lantar4/remnabot/commit/928ce20a011618ee4793bc50c068eafde65e0946))
* **remnawave:** карта uuid не праймилась, холостой прогон писал в БД ([e9445ee](https://github.com/k4lantar4/remnabot/commit/e9445ee2f12c811965e4936687258d79152c707a))
* **remnawave:** клэмп size в 1..1000 для /api/users/stream ([7bf8047](https://github.com/k4lantar4/remnabot/commit/7bf8047e8bde7c56b55680cbc9e18f45f6765fc1))
* **remnawave:** ложный успех при удалении устройств, окно суток и happ-ссылка ([b007de8](https://github.com/k4lantar4/remnabot/commit/b007de8f4117d4626a03fd3c54316a1e34aaaee6))
* **remnawave:** не подставлять None вместо класса ошибки при провале импорта ([775e507](https://github.com/k4lantar4/remnabot/commit/775e5075769bc8ff892b8b359a6f03a4f1e12d1d))
* **remnawave:** не терять и не подсовывать протухшую идентичность подписки ([bef6e6d](https://github.com/k4lantar4/remnabot/commit/bef6e6d7d1db65660800b58e7fc20856f40b0751))
* **remnawave:** несовпадение владельца снова вело к очистке, а не к перепривязке ([ea4db92](https://github.com/k4lantar4/remnabot/commit/ea4db928b3d9dd171af3d00b8f9c706d4cc47fca))
* **remnawave:** повторный прогон бэкфила и выбор живой подписки ([b515c3d](https://github.com/k4lantar4/remnabot/commit/b515c3d30bb762f89b425069d5685d8750168ce0))
* **remnawave:** поля, которых нет в контракте 3.0.0, и след прогона бэкфила ([babf846](https://github.com/k4lantar4/remnabot/commit/babf84634d676a71e7c2b77f03ec7aadaefb391f))
* **remnawave:** порядок UPDATE'ов при переносе панельного id ([28b01f1](https://github.com/k4lantar4/remnabot/commit/28b01f1ee71841a2d9654e357c26729f8a6f09af))
* **remnawave:** протухший id больше не решает за пользователя ([83c6415](https://github.com/k4lantar4/remnabot/commit/83c6415c11d007151dde99dfea61178382ba1e8a))
* **remnawave:** след прогона врал, а защита индекса не мешала записи в панель ([fe3dc5b](https://github.com/k4lantar4/remnabot/commit/fe3dc5bb42cef0b1becbaa56c6ad9be3076c9276))
* **remnawave:** суточная проверка снова не сработала бы, а граница id ослабла ([3c31285](https://github.com/k4lantar4/remnabot/commit/3c31285a4c920b715dc57253c6525af82972a5b6))
* **remnawave:** точный ключ не должен проигрывать догадке и ронять синк ([d2fd3d5](https://github.com/k4lantar4/remnabot/commit/d2fd3d5db91ed82aea639b5602dc9f900aeaa18b))
* **remnawave:** холостой прогон бэкфила называл свой отчёт «conflicts» ([6b7204b](https://github.com/k4lantar4/remnabot/commit/6b7204b1d5cf5a1a6e4cffa9972aef9f55995500))
* **rich-menu:** RICH_MESSAGE_DATE_INVALID на подписках дальше ~3 лет ([9ee31d3](https://github.com/k4lantar4/remnabot/commit/9ee31d3d57e5fcac58bb26886b256ab62fb6884b))
* **rich-menu:** дать включить rich-меню без логотипа ([add7327](https://github.com/k4lantar4/remnabot/commit/add7327d479202e8c12a232eeb7fd4b28157da25))
* **rich-menu:** премиум-эмодзи из текстов меню уходили клиенту сырым тегом ([1feab43](https://github.com/k4lantar4/remnabot/commit/1feab432bc4da949ecbf15e7729320990272af30))
* **rich:** make usernames clickable ([42ff65a](https://github.com/k4lantar4/remnabot/commit/42ff65a97b14f2d6cc88408785e74d9d5ee79ff2))
* **rich:** ссылку на профиль ставим только настоящему Telegram-логину ([accda9a](https://github.com/k4lantar4/remnabot/commit/accda9aa0a69dc1b2fb34d0c9ab036c722020b7e))
* **sales:** allow catalog buy of a tariff the user already has ([6d595d5](https://github.com/k4lantar4/remnabot/commit/6d595d51a791a9da8250a2185dbaccc905f73e55))
* **sales:** cabinet catalog purchase creates when subscription_id is absent ([05f6d7b](https://github.com/k4lantar4/remnabot/commit/05f6d7b6c3711a83fb77c2a9978cfaa102afce39))
* **sales:** create a new row on menu_buy instead of extending by tariff id ([a987d5f](https://github.com/k4lantar4/remnabot/commit/a987d5ffab41d04e6639c1bc6d409e657c257a61))
* **sales:** create on custom and daily catalog confirms when pin is empty ([fb8759f](https://github.com/k4lantar4/remnabot/commit/fb8759fd3e11abdfe09a3795cf62d410f52f3a21))
* **sales:** identity A titles on Telegram list and rich menu ([e3a9ad4](https://github.com/k4lantar4/remnabot/commit/e3a9ad45301d5b9c508c9cd566fc16331ecc8862))
* **sales:** skip Lava next-charge shift when disabled so extend can sync the panel ([23df086](https://github.com/k4lantar4/remnabot/commit/23df0860785574b07e1324d2ceaadeabea53a39e))
* **search:** регистронезависимый поиск по юзерам для кириллицы ([5323803](https://github.com/k4lantar4/remnabot/commit/53238035f72b4a1ee7554196d0899e9bde23d6df))
* **security:** линейная проверка HTML вместо квадратичной ([a248cea](https://github.com/k4lantar4/remnabot/commit/a248cea2a9e9f7e82d9945c732eadeabb6b8e5e3))
* **security:** линейная проверка HTML вместо квадратичной ([38c0b06](https://github.com/k4lantar4/remnabot/commit/38c0b0663f1f671455206570341e3b57f19f827f))
* **security:** линейное вырезание тегов вместо квадратичного ([34879b1](https://github.com/k4lantar4/remnabot/commit/34879b11c7411ee5df5765ded7cff053b1fa672e))
* **settings:** булеву настройку со списком вариантов нельзя было сохранить ([1ee5f60](https://github.com/k4lantar4/remnabot/commit/1ee5f6087a08f1877c313812a7c78a77af705b47))
* **settings:** осмысленные категории для настроек, начинающихся с глагола ([e6f1505](https://github.com/k4lantar4/remnabot/commit/e6f150537ad57b24f95f9f7024d0d329c5cd6c56))
* **settings:** отображать DEVICES_SELECTION_DISABLED_AMOUNT как число, а не цену ([0f1968e](https://github.com/k4lantar4/remnabot/commit/0f1968ec658148f0920bfaa253ea3c59c9f6df1f)), closes [#1658](https://github.com/k4lantar4/remnabot/issues/1658)
* **startup:** однозначно широкие статус-значки в резюме запуска ([3dae638](https://github.com/k4lantar4/remnabot/commit/3dae638755499094d405601a9fe81eecf5389fbc))
* **start:** видео не доходило до самой команды /start ([1f61e0b](https://github.com/k4lantar4/remnabot/commit/1f61e0bec2686314f7e151b00d4b4e616e749329))
* **subscription:** device_limit = 0 — это безлимит, а не ноль устройств ([51688fc](https://github.com/k4lantar4/remnabot/commit/51688fc4573569dae2fe9855da93eeebb6d1188a))
* **subscription:** NameError при продлении тарифа после списания денег ([82b7131](https://github.com/k4lantar4/remnabot/commit/82b7131154e93f2bc4719cae4c64c171648e0f96))
* **subscription:** не показывать неоплаченный черновик триала как подписку ([fe992c6](https://github.com/k4lantar4/remnabot/commit/fe992c65817eff1156f2f7d56232d59a1bf385fe))
* **support:** дефолты SLA в коде развести с .env.example не в пользу спама ([38110e5](https://github.com/k4lantar4/remnabot/commit/38110e50fee3a8d57f42c66a72f238582e5a2a28))
* **support:** отдавать внешний URL поддержки в конфиге кабинета ([b270349](https://github.com/k4lantar4/remnabot/commit/b27034969f11d6bf41e4e8a81da351fabcb965f4))
* **support:** проверять бан поддержки и режим тикетов в веб-сокете ([f3acc69](https://github.com/k4lantar4/remnabot/commit/f3acc69a8fcae3efdbd5a18153a05a75473a4136))
* **support:** синхронизировать persisted-режим поддержки в settings при старте ([2184e58](https://github.com/k4lantar4/remnabot/commit/2184e58da48831c914ac68806baa13008d3f0a85))
* **tariff:** превью покупки считает цену тем же PricingEngine, что и confirm ([baef285](https://github.com/k4lantar4/remnabot/commit/baef285194868a8c422833b37f33b0e941abc547))
* **tariff:** СБП-оформление доступно с экрана «недостаточно средств» ([a5a13ae](https://github.com/k4lantar4/remnabot/commit/a5a13aea1d9249b4dc7eca8b1c4851e9acaa337e))
* **tickets:** длинные сообщения обрезались и не показывались целиком ([064e067](https://github.com/k4lantar4/remnabot/commit/064e0673b86db4195a85ec5eaf5e349e3324fef2))
* **tickets:** длинные сообщения обрезались и не показывались целиком ([3be6da7](https://github.com/k4lantar4/remnabot/commit/3be6da7a8c6c8fc423d110850f1376207c82d2d1))
* **tickets:** передавать db в новые event_emitter-эмиссии кабинета ([8eaef7f](https://github.com/k4lantar4/remnabot/commit/8eaef7f1ffbddc7947d591a87aaeaa643b3f9cfa))
* **tickets:** проверять блокировку поддержки и лимит тикетов в кабинете ([2887ef7](https://github.com/k4lantar4/remnabot/commit/2887ef70cadbe85b15e974429ac0e5d283c80515))
* **tickets:** режим поддержки в кабинете читать у сервиса, а не из settings ([bd93d7e](https://github.com/k4lantar4/remnabot/commit/bd93d7e8ba7e3908fc73684c5782ef9d633fd065))
* **tickets:** экранировать превью ответа в уведомлении пользователю ([f898414](https://github.com/k4lantar4/remnabot/commit/f898414bb4dfca6350d02242088bae44fe7fce8d))
* **traffic:** не читать даты периода вне ветки, которая их задаёт ([993ea75](https://github.com/k4lantar4/remnabot/commit/993ea75c90ebc769d6fe064c21f8fbf05bfc28d9))
* **tribute:** per-событийный ключ идемпотентности вместо donation_request_id ([e9515ad](https://github.com/k4lantar4/remnabot/commit/e9515adb725f121d5b13b174c6ea8933228fbb17))
* **webhooks:** bound payment-callback concurrency to prevent DB pool exhaustion ([f72effc](https://github.com/k4lantar4/remnabot/commit/f72effce7548b9a3419ee7002f0acebeff714762))
* восстановить забытые импорты, падавшие NameError в проде ([9bedd81](https://github.com/k4lantar4/remnabot/commit/9bedd81c1f6c2e44aaf8ff299bd3db7e7848df1d))
* восстановление затёртых dev-фич и фиксы grace-подсистемы (PR [#3075](https://github.com/k4lantar4/remnabot/issues/3075)) ([35206d7](https://github.com/k4lantar4/remnabot/commit/35206d7ba0bd9a2f5c17a42f49f3e919112d6773))
* объявить литеральные пути уровней наград выше /{user_id} ([94df5bb](https://github.com/k4lantar4/remnabot/commit/94df5bbf3adafb4f3faa287fba9f0b9fef207f4a))
* устранить замечания CodeQL из PR [#3123](https://github.com/k4lantar4/remnabot/issues/3123) ([c7cc8b4](https://github.com/k4lantar4/remnabot/commit/c7cc8b4585b94766be87fd5a260ec8f436a5b7a8))


### Performance

* **etoplatezhi:** ack webhook instantly, process callback in background ([2acea3f](https://github.com/k4lantar4/remnabot/commit/2acea3f6c369f104c2244404474f3611afbbfe96))


### Refactoring

* **campaigns:** вынести привязку к кампании в сервис ([a813083](https://github.com/k4lantar4/remnabot/commit/a813083c7a2140b1193c1ff10cb4a7809f5e95e3))
* share gift activation across channels ([b42b75d](https://github.com/k4lantar4/remnabot/commit/b42b75d524d8aba415f7688bccb03c9c50ea7b39))
* share gift checkout domain with bot ([e41d655](https://github.com/k4lantar4/remnabot/commit/e41d6552090cd8006da169e69e8169a6022057ab))


### Documentation

* add day-1 Telegram overlay implementation plan ([e804a76](https://github.com/k4lantar4/remnabot/commit/e804a7619630145bb6002c0aeda88f740cc4ca92))
* **day1:** mark plan COMPLETE — check all Task 1–10 / Part B steps ([ae2d435](https://github.com/k4lantar4/remnabot/commit/ae2d435a390ee0fc660f3ce118babbef636eab21))
* **day1:** record operator smoke PASS (A4 pause + list order) ([2a5e867](https://github.com/k4lantar4/remnabot/commit/2a5e867d632153ce2d7cef56965b186a29f67768))
* **E8:** stop rehearsal Remnawave from controlling production nodes ([f88e36d](https://github.com/k4lantar4/remnabot/commit/f88e36dc8aca21b471307cd01ccb80601c6b7462))
* freeze full cutover plan and slim live execution authority ([290a76e](https://github.com/k4lantar4/remnabot/commit/290a76e669df74a2c0b87f919a5baacdd8d4be4a))
* governance topology audit and pre-M0 artifacts ([a168a81](https://github.com/k4lantar4/remnabot/commit/a168a817cbfdbab020ed3b328c596d866dfbc2a6))
* lock cabinet Layer A design and implementation plan ([bf2c656](https://github.com/k4lantar4/remnabot/commit/bf2c656387c7fc731fff484ee69d69fd06e4b1ef))
* lock day-1 Telegram+cabinet overlay design ([17236a9](https://github.com/k4lantar4/remnabot/commit/17236a948323f7855b3bc88f2f422ff88eb4aeec))
* **M0-T2:** WIP inventory after remnabot1 re-fork ([f10ebd7](https://github.com/k4lantar4/remnabot/commit/f10ebd754969da162580ac9fb36e43a28e07e47f))
* **M0-T3:** cabinet git reconciliation ([8b70bd7](https://github.com/k4lantar4/remnabot/commit/8b70bd75648627764e23c6cdd5b0615d7f0dde44))
* **M0-T4:** record baseline tag 89fa7dc5 ([3f79850](https://github.com/k4lantar4/remnabot/commit/3f798500acf0971e4400661c146b8a50d2c229d2))
* **M0-T5:** upstream tracking baseline ([3926dd0](https://github.com/k4lantar4/remnabot/commit/3926dd03957adefc0cb78897be0679c03b6c3886))
* **M0-T6:** alembic graft strategy ([9aa0d69](https://github.com/k4lantar4/remnabot/commit/9aa0d69a86de9a1a585460ae511da113cb57a2e7))
* **M0:** align handoff SHA with checkpoint closeout ([c313b0d](https://github.com/k4lantar4/remnabot/commit/c313b0da516343bf05a581bbfce281a1da169c3f))
* **M0:** checkpoint remaining evidence; wait for start M1 ([2877a28](https://github.com/k4lantar4/remnabot/commit/2877a28fad3d47d8a3dcb34659983aaef7952388))
* **M0:** clear leftover remaining-M0 plan contradictions ([e453d97](https://github.com/k4lantar4/remnabot/commit/e453d977e292a95fee8024c48a8552f19d9bed6b))
* **M0:** make MVP plan the single authority after spec/errata deletion ([0c5fa2d](https://github.com/k4lantar4/remnabot/commit/0c5fa2d174b5cad5dec5798b171239ff9de02229))
* **M1-T3:** RC environment A-E matrix ([a1b4c59](https://github.com/k4lantar4/remnabot/commit/a1b4c59fed7d4d58d42984e9b4648bc62cb45631))
* **M2-T1:** restore bot dump into rehearsal_bot_pg15 (G1 PASS) ([f939e88](https://github.com/k4lantar4/remnabot/commit/f939e889e4fb076fdf81eb18e010a33e0c8ed27b))
* **M2-T2:** restore Remnawave 2.8.1 dump into rehearsal_rw_pg17 (G2 PASS) ([014b1bc](https://github.com/k4lantar4/remnabot/commit/014b1bcc170fe1e5e6cfdfc0d85e59562d4f83c7))
* **M3-ID:** prove 3.4.3 identity API (uuid dropped, shortUuid key) ([9af645a](https://github.com/k4lantar4/remnabot/commit/9af645a337414f71ca25118c65831ad911772051))
* **M3-T0:** choose Remnawave 3.4.3 as 3.x candidate tag ([1597e94](https://github.com/k4lantar4/remnabot/commit/1597e946d99996291e550ad900ba129a8cd60888))
* **M3-T2:** keep Remnawave rehearsal on PostgreSQL 17.6 ([5edaebb](https://github.com/k4lantar4/remnabot/commit/5edaebb4419e4a79c36002181542235fed260827))
* **M4-T1:** record 4.2 boot gaps vs remnabot 0104 schema ([c3c66c5](https://github.com/k4lantar4/remnabot/commit/c3c66c5dc9191073ac7e945b0d55233408ef679f))
* **M5-T1:** RC cabinet split-compose evidence ([287d669](https://github.com/k4lantar4/remnabot/commit/287d669c126379a98beb459c52b6bf7df742cd0d))
* **M5-T2:** pin canonical cabinet source ([de567ca](https://github.com/k4lantar4/remnabot/commit/de567ca3a8b946f9e7e1b1ba22b71694a7e9a0ee))
* **M5-T3:** record RC cabinet JWT fingerprint isolation ([515c09f](https://github.com/k4lantar4/remnabot/commit/515c09fe104a76bdf20b1a72b6bf59cb7577de31))
* **M6-T4:** C2C RC PASS (isolated chat) ([08a562d](https://github.com/k4lantar4/remnabot/commit/08a562d7a8dc721301912688badb61acedcef405))
* **plan:** pin cabinet list search to donor pagination and summary query ([97b4aa8](https://github.com/k4lantar4/remnabot/commit/97b4aa88e6603dc520875ad1997dc8e34ba4081f))
* **plan:** RC public hostname is panel.rookari.com ([634dc03](https://github.com/k4lantar4/remnabot/commit/634dc034b00e297636c0f50f03c83a79f76c7a29))
* **plan:** sales buy-new isolation and panel-sync tasks ([bb7be44](https://github.com/k4lantar4/remnabot/commit/bb7be4426b804487ac32af5e5d1dd5b9d5d73ed3))
* **plan:** sales-surface overlay tasks (buy-new, identity A, cabinet UX) ([80c941e](https://github.com/k4lantar4/remnabot/commit/80c941e07a87202ec4f013379ccb4b1c8656eb91))
* **platega:** отмена автооплаты, хук при удалении подписки, админка кабинета ([47f5252](https://github.com/k4lantar4/remnabot/commit/47f5252ffcc188557907dfd8c0c20529c3f06ad6))
* **platega:** план реализации бэкенда+бота рекуррентных СБП (Plan A) ([7a8bd2e](https://github.com/k4lantar4/remnabot/commit/7a8bd2ee1358f65e4f140f88194d6d02dfd77c83))
* **platega:** спека рекуррентных СБП-платежей Platega ([9f876aa](https://github.com/k4lantar4/remnabot/commit/9f876aa2836c15358995c31d092a86edd90e4467))
* **remnawave:** точное обоснование раздельных flush при переносе id ([6eb80c6](https://github.com/k4lantar4/remnabot/commit/6eb80c6957987a48098bfffe2b11701dc4267285))
* **smoke:** note A4.2 pause fix for re-test ([5005327](https://github.com/k4lantar4/remnabot/commit/500532780fa3e151a28c399a8544deae8671132b))
* **smoke:** record A4-follow-up rebuild identities ([61ba2c9](https://github.com/k4lantar4/remnabot/commit/61ba2c947017f6e18406e0b893ee8089f6bfe585))
* **smoke:** record Telegram A1–A3 PASS and A4 FAIL ([6ce6d77](https://github.com/k4lantar4/remnabot/commit/6ce6d779644e078591429e3b6ac108c24465d644))
* spec for slimming the cutover plan and session brakes ([fa6b037](https://github.com/k4lantar4/remnabot/commit/fa6b037068976a3be74f657de1b950388150396f))
* **spec:** lock buy-new isolation and panel sync after overlay gaps ([aa17ff2](https://github.com/k4lantar4/remnabot/commit/aa17ff2dffcf23fd25026552cc16ed16cddd337a))
* **spec:** lock sales-surface overlay (buy-new, identity A) ([e141739](https://github.com/k4lantar4/remnabot/commit/e14173975febb54c30d97b869939693f14f114b8))
* unify day-1 overlay plan; drop absorbed plan files ([ba4550f](https://github.com/k4lantar4/remnabot/commit/ba4550fca5ef8b1a645e4fe4d908a6ca580f2291))
* актуализация комментария get_receipt_print_url после фикса библиотеки ([#3083](https://github.com/k4lantar4/remnabot/issues/3083)) ([3b4f37f](https://github.com/k4lantar4/remnabot/commit/3b4f37fa247dcbe53c3545a8296662df0400dc38))
