    ...
    keyboard = [
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_RULES_EDIT_BUTTON", "📝 Edit rules"), callback_data="admin_edit_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_RULES_VIEW_BUTTON", "👀 View rules"), callback_data="admin_view_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_RULES_CLEAR_BUTTON", "🗑️ Clear rules"), callback_data="admin_clear_rules"
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_RULES_HTML_HELP", "ℹ️ HTML help"), callback_data="admin_rules_help"
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_RULES_BACK", "⬅️ Back"), callback_data="admin_submenu_settings"
            )
        ],
    ]
...
async def view_current_rules(callback: types.CallbackQuery, db_user: User, db: AsyncSession):
    try:
        ...
        if not is_valid:
            warning = texts.t(
                "ADMIN_RULES_HTML_WARNING", "\n\n⚠️ <b>Warning:</b> HTML error found in rules: {error}"
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_EDIT", "✏️ Edit"), callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_CLEAR", "🗑️ Clear"), callback_data="admin_clear_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_BACK", "⬅️ Back"), callback_data="admin_rules"
                        )
                    ],
                ]
            ),
...
async def start_edit_rules(callback: types.CallbackQuery, db_user: User, state: FSMContext, db: AsyncSession):
    try:
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    ...
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_CANCEL", "❌ Cancel"), callback_data="admin_rules"
                        )
                    ],
                ]
            ),
        ...
        await callback.answer(
            texts.t("ADMIN_RULES_EDIT_LOAD_ERROR", "❌ Error loading rules for editing"), show_alert=True
        )
        ...
        await message.answer(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_SAVE", "✅ Save"), callback_data="admin_save_rules"
                        ),
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_CANCEL", "❌ Cancel"), callback_data="admin_rules"
                        ),
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_TRY_AGAIN", "🔄 Try again"), callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_BACK_TO_RULES", "📋 Back to rules"), callback_data="admin_rules"
                        )
                    ],
                ]
            ),
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_VIEW", "👀 View"), callback_data="admin_view_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_TRY_AGAIN", "🔄 Try again"), callback_data="admin_save_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
    ...
    await callback.message.edit_text(
        ...
        reply_markup=types.InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    types.InlineKeyboardButton(
                        text=texts.t("ADMIN_RULES_CLEAR_YES", "✅ Yes, clear"),
        ...
        await callback.message.edit_text(
            ...
            reply_markup=types.InlineKeyboardMarkup(
                inline_keyboard=[
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_CREATE_NEW", "📝 Create new"), callback_data="admin_edit_rules"
                        )
                    ],
                    [
                        types.InlineKeyboardButton(
                            text=texts.t("ADMIN_RULES_VIEW_CURRENT", "👀 View current"),
