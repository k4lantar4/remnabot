    ...
    keyboard = [
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_LIST", "📋 Subscription list"), callback_data="admin_subs_list"
            ),
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_EXPIRING", "⏰ Expiring"), callback_data="admin_subs_expiring"
            ),
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_STATS", "📊 Statistics"), callback_data="admin_subs_stats"
            ),
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_GEOGRAPHY", "🌍 Geography"), callback_data="admin_subs_countries"
            ),
        ],
...
async def show_subscriptions_list(callback: types.CallbackQuery, db_user: User, db: AsyncSession, page: int = 1):
    ...
    if not subscriptions:
        ...
        for i, sub in enumerate(subscriptions, 1 + (page - 1) * 10):
            ...
            status = (
                texts.t("ADMIN_SUBS_STATUS_ACTIVE", "✅ Active")
                if sub.is_active
                else texts.t("ADMIN_SUBS_STATUS_INACTIVE", "❌ Inactive")
            )
    ...
    keyboard.extend(
        [
            [
                types.InlineKeyboardButton(
                    text=texts.t("ADMIN_SUBS_BUTTON_REFRESH", "🔄 Refresh"), callback_data="admin_subs_list"
                )
            ],
...
"""
    ...
    keyboard = [
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_SEND_REMINDERS", "📨 Send reminders"),
                callback_data="admin_send_expiry_reminders",
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_REFRESH", "🔄 Refresh"), callback_data="admin_subs_expiring"
            )
        ],
        [types.InlineKeyboardButton(text=texts.BACK, callback_data="admin_subscriptions")],
    ]
...
"""
    ...
    keyboard = [[types.InlineKeyboardButton(text=texts.BACK, callback_data="admin_subscriptions")]]
...
"""
    ...
    keyboard = [
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_REFRESH", "🔄 Refresh"), callback_data="admin_subs_countries"
            )
        ],
        [
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_NODE_STATS", "📊 Node statistics"), callback_data="admin_rw_nodes"
            ),
            types.InlineKeyboardButton(
                text=texts.t("ADMIN_SUBS_BUTTON_SQUADS", "🔧 Squads"), callback_data="admin_rw_squads"
            ),
        ],
        [types.InlineKeyboardButton(text=texts.BACK, callback_data="admin_subscriptions")],
    ]
...
"""
    ...
    await callback.message.edit_text(
        texts.t("ADMIN_SUBS_REMINDERS_SENT", "✅ Reminders sent: {sent} of {total}").format(
