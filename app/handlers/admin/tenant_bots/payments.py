...
Select payment method to configure:""",
        ...
        zarinpal_merchant=zarinpal_merchant_id[:20] + "..."
        if zarinpal_merchant_id and len(zarinpal_merchant_id) > 20
        else (zarinpal_merchant_id or "Not set"),
    ...
    keyboard_buttons.append(
        [
            types.InlineKeyboardButton(
                text="⚙️ Configure Card-to-Card", callback_data=f"admin_tenant_bot_cards:{bot_id}:0"
            )
        ]
    )
    ...
    keyboard_buttons.append(
        [types.InlineKeyboardButton(text="⚙️ Configure Zarinpal", callback_data=f"admin_tenant_bot_zarinpal:{bot_id}")]
    )
...
Select action:""",
    ...
    keyboard_buttons.append(
        [
            types.InlineKeyboardButton(
                text="✏️ Edit Merchant ID", callback_data=f"admin_tenant_bot_edit_zarinpal_merchant:{bot_id}"
            )
        ]
    )
    keyboard_buttons.append(
        [
            types.InlineKeyboardButton(
                text="✏️ Toggle Sandbox", callback_data=f"admin_tenant_bot_toggle_zarinpal_sandbox:{bot_id}"
            )
        ]
    )
    ...
    # Back button
    keyboard_buttons.append(
        [types.InlineKeyboardButton(text=texts.BACK, callback_data=f"admin_tenant_bot_payments:{bot_id}")]
    )
