...
def get_admin_support_submenu_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SUPPORT_TICKETS", "🎫 Support tickets"), callback_data="admin_tickets"
                )
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SUPPORT_AUDIT", "🧾 Moderator audit"), callback_data="admin_support_audit"
                )
            ],
            [
                InlineKeyboardButton(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SETTINGS_MAINTENANCE", "🔧 Maintenance"), callback_data="maintenance_panel"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_admin_system_submenu_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SYSTEM_UPDATES", "📄 Updates"), callback_data="admin_updates"
                ),
                InlineKeyboardButton(text=_t(texts, "ADMIN_SYSTEM_BACKUPS", "🗄️ Backups"), callback_data="backup_panel"),
            ],
            [InlineKeyboardButton(text=_t(texts, "ADMIN_SYSTEM_LOGS", "🧾 Logs"), callback_data="admin_system_logs")],
...
def get_admin_reports_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REPORTS_PREVIOUS_DAY", "📆 Yesterday"), callback_data="admin_reports_daily"
                )
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REPORTS_LAST_WEEK", "🗓️ Last week"), callback_data="admin_reports_weekly"
                )
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REPORTS_LAST_MONTH", "📅 Last month"), callback_data="admin_reports_monthly"
                )
            ],
            [InlineKeyboardButton(text=texts.BACK, callback_data="admin_panel")],
        ]
...
def get_admin_users_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USERS_ALL", "👥 All users"), callback_data="admin_users_list"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USERS_SEARCH", "🔍 Search"), callback_data="admin_users_search"
                ),
            ],
            [
                InlineKeyboardButton(text=texts.ADMIN_STATISTICS, callback_data="admin_users_stats"),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USERS_INACTIVE", "🗑️ Inactive"), callback_data="admin_users_inactive"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USERS_FILTERS", "⚙️ Filters"), callback_data="admin_users_filters"
                )
            ],
            [
                InlineKeyboardButton(
...
def get_admin_subscriptions_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SUBSCRIPTIONS_ALL", "📱 All subscriptions"), callback_data="admin_subs_list"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SUBSCRIPTIONS_EXPIRING", "⏰ Expiring"), callback_data="admin_subs_expiring"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_admin_promocodes_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODES_ALL", "🎫 All promo codes"), callback_data="admin_promo_list"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODES_CREATE", "➕ Create"), callback_data="admin_promo_create"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_admin_campaigns_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CAMPAIGNS_LIST", "📋 Campaign list"), callback_data="admin_campaigns_list"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CAMPAIGNS_CREATE", "➕ Create"), callback_data="admin_campaigns_create"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_daily_contest_manage_keyboard(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_EDIT_PRIZE", "🏅 Приз (дни)"),
                    callback_data=f"admin_daily_edit_{template_id}_prize_days",
                ),
                InlineKeyboardButton(
...
def get_campaign_management_keyboard(campaign_id: int, is_active: bool, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BACK_TO_LIST", "⬅️ Back to list"), callback_data="admin_campaigns_list"
                )
            ],
        ]
    )
...
def get_promocode_management_keyboard(promo_id: int, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_EDIT", "✏️ Edit"), callback_data=f"promo_edit_{promo_id}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_TOGGLE", "🔄 Status"), callback_data=f"promo_toggle_{promo_id}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_STATS", "📊 Statistics"), callback_data=f"promo_stats_{promo_id}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_DELETE", "🗑️ Delete"), callback_data=f"promo_delete_{promo_id}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BACK_TO_LIST", "⬅️ Back to list"), callback_data="admin_promo_list"
                )
            ],
        ]
    )
...
def get_admin_messages_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MESSAGES_ALL_USERS", "📨 All users"), callback_data="admin_msg_all"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MESSAGES_BY_CRITERIA", "🔍 By criteria"), callback_data="admin_msg_custom"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MESSAGES_HISTORY", "📋 History"), callback_data="admin_msg_history"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_admin_monitoring_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_START", "▶️ Start"), callback_data="admin_mon_start"
                ),
                InlineKeyboardButton(text=_t(texts, "ADMIN_MONITORING_STOP", "⏸️ Stop"), callback_data="admin_mon_stop"),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_STATUS", "📊 Status"), callback_data="admin_mon_status"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_LOGS", "📋 Logs"), callback_data="admin_mon_logs"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_SETTINGS_BUTTON", "⚙️ Settings"), callback_data="admin_mon_settings"
                )
            ],
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REMNAWAVE_MANAGE_NODES", "🖥️ Manage nodes"), callback_data="admin_rw_nodes"
                ),
            ],
            [
                InlineKeyboardButton(text=_t(texts, "ADMIN_REMNAWAVE_SYNC", "🔄 Sync"), callback_data="admin_rw_sync"),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REMNAWAVE_MANAGE_SQUADS", "🌐 Manage squads"), callback_data="admin_rw_squads"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REMNAWAVE_MIGRATION", "🚚 Migration"), callback_data="admin_rw_migration"
                )
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_REMNAWAVE_TRAFFIC", "📈 Traffic"), callback_data="admin_rw_traffic"
                )
            ],
            [InlineKeyboardButton(text=texts.BACK, callback_data="admin_submenu_settings")],
        ]
...
def get_admin_statistics_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_USERS", "👥 Users"), callback_data="admin_stats_users"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_SUBSCRIPTIONS", "📱 Subscriptions"), callback_data="admin_stats_subs"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_REVENUE", "💰 Revenue"), callback_data="admin_stats_revenue"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_REFERRALS", "🤝 Referrals"), callback_data="admin_stats_referrals"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_SUMMARY", "📊 Summary"), callback_data="admin_stats_summary"
                )
            ],
            [InlineKeyboardButton(text=texts.BACK, callback_data="admin_submenu_promo")],
        ]
...
def get_user_management_keyboard(
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_USER_BALANCE", "💰 Balance"), callback_data=f"admin_user_balance_{user_id}"
            ),
            InlineKeyboardButton(
    ...
    if user_status == "active":
        keyboard.append(
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USER_BLOCK", "🚫 Block"), callback_data=f"admin_user_block_{user_id}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USER_DELETE", "🗑️ Delete"), callback_data=f"admin_user_delete_{user_id}"
                ),
            ]
        )
        ...
        keyboard.append(
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USER_UNBLOCK", "✅ Unblock"), callback_data=f"admin_user_unblock_{user_id}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USER_DELETE", "🗑️ Delete"), callback_data=f"admin_user_delete_{user_id}"
                ),
        ...
        keyboard.append(
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_USER_ALREADY_DELETED", "❌ User deleted"), callback_data="noop"
                )
            ]
        )
...
def get_promocode_type_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_TYPE_BALANCE", "💰 Balance"), callback_data="promo_type_balance"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_TYPE_DAYS", "📅 Subscription days"), callback_data="promo_type_days"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PROMOCODE_TYPE_TRIAL", "🎁 Trial"), callback_data="promo_type_trial"
                ),
                InlineKeyboardButton(
...
def get_broadcast_target_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_TARGET_ALL", "👥 Everyone"), callback_data="broadcast_all"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_TARGET_TRIAL", "🎁 Trial"), callback_data="broadcast_trial"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_TARGET_EXPIRING", "⏰ Expiring"), callback_data="broadcast_expiring"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_TARGET_EXPIRED", "🔚 Expired"), callback_data="broadcast_expired"
                ),
            ],
            [
                InlineKeyboardButton(
...
def get_custom_criteria_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CRITERIA_TODAY", "📅 Today"), callback_data="criteria_today"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CRITERIA_WEEK", "📅 Last 7 days"), callback_data="criteria_week"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CRITERIA_MONTH", "📅 Last month"), callback_data="criteria_month"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CRITERIA_REFERRALS", "🤝 Via referrals"), callback_data="criteria_referrals"
                ),
                InlineKeyboardButton(
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_CRITERIA_DIRECT", "🎯 Direct registration"), callback_data="criteria_direct"
                )
            ],
            [InlineKeyboardButton(text=texts.BACK, callback_data="admin_messages")],
        ]
...
def get_broadcast_history_keyboard(page: int, total_pages: int, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    keyboard.extend(
        [
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_HISTORY_REFRESH", "🔄 Refresh"), callback_data="admin_msg_history"
                )
            ],
            [InlineKeyboardButton(text=texts.BACK, callback_data="admin_messages")],
        ]
...
def get_sync_options_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    texts = get_texts(language)
    keyboard = [
        [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_FULL", "🔄 Full sync"), callback_data="sync_all_users")],
        [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_TO_PANEL", "⬆️ Sync to panel"), callback_data="sync_to_panel")],
        [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_ONLY_NEW", "🆕 New only"), callback_data="sync_new_users")],
        [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_UPDATE", "📈 Update data"), callback_data="sync_update_data")],
        [
            InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_VALIDATE", "🔍 Validate"), callback_data="sync_validate"),
            InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_CLEANUP", "🧹 Cleanup"), callback_data="sync_cleanup"),
        ],
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_SYNC_RECOMMENDATIONS", "💡 Recommendations"), callback_data="sync_recommendations"
            )
        ],
...
def get_sync_confirmation_keyboard(sync_type: str, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_SYNC_CONFIRM", "✅ Confirm"), callback_data=f"confirm_{sync_type}"
            )
        ],
...
def get_sync_result_keyboard(sync_type: str, has_errors: bool = False, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    if has_errors:
        keyboard.append(
            [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_RETRY", "🔄 Retry"), callback_data=f"sync_{sync_type}")]
        )
    ...
    keyboard.extend(
        [
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_STATS_BUTTON", "📊 Statistics"), callback_data="admin_rw_system"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SYNC_VALIDATE", "🔍 Validate"), callback_data="sync_validate"
                ),
            ],
            [InlineKeyboardButton(text=_t(texts, "ADMIN_SYNC_BACK", "⬅️ Back to sync"), callback_data="admin_rw_sync")],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BACK_TO_MAIN", "🏠 Back to main menu"), callback_data="admin_remnawave"
                )
            ],
        ]
    )
...
def get_period_selection_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=_t(texts, "ADMIN_PERIOD_TODAY", "📅 Today"), callback_data="period_today"),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_PERIOD_YESTERDAY", "📅 Yesterday"), callback_data="period_yesterday"
                ),
            ],
            [
                InlineKeyboardButton(text=_t(texts, "ADMIN_PERIOD_WEEK", "📅 Week"), callback_data="period_week"),
                InlineKeyboardButton(text=_t(texts, "ADMIN_PERIOD_MONTH", "📅 Month"), callback_data="period_month"),
            ],
            [InlineKeyboardButton(text=_t(texts, "ADMIN_PERIOD_ALL", "📅 All time"), callback_data="period_all")],
...
def get_node_management_keyboard(node_uuid: str, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_NODE_ENABLE", "▶️ Enable"), callback_data=f"node_enable_{node_uuid}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_NODE_DISABLE", "⏸️ Disable"), callback_data=f"node_disable_{node_uuid}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_NODE_RESTART", "🔄 Restart"), callback_data=f"node_restart_{node_uuid}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_NODE_STATS", "📊 Statistics"), callback_data=f"node_stats_{node_uuid}"
                ),
            ],
...
def get_squad_management_keyboard(squad_uuid: str, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SQUAD_EDIT", "✏️ Edit"), callback_data=f"squad_edit_{squad_uuid}"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SQUAD_DELETE", "🗑️ Delete squad"), callback_data=f"squad_delete_{squad_uuid}"
                ),
            ],
...
def get_squad_edit_keyboard(squad_uuid: str, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SQUAD_RENAME", "✏️ Rename"), callback_data=f"squad_rename_{squad_uuid}"
                ),
            ],
            [
                InlineKeyboardButton(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_STOP_HARD", "⏹️ Stop"), callback_data="admin_mon_stop"
                ),
            ],
            [
                InlineKeyboardButton(
            ...
            [
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_STATISTICS", "📊 Statistics"), callback_data="admin_mon_statistics"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BACK_TO_ADMIN", "⬅️ Back to admin"), callback_data="admin_panel"
                )
            ],
        ]
    )
...
def get_monitoring_logs_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_HISTORY_REFRESH", "🔄 Refresh"), callback_data="admin_mon_logs"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_CLEAR_OLD", "🗑️ Clear old"), callback_data="admin_mon_clear_logs"
                ),
            ],
...
def get_monitoring_logs_navigation_keyboard(
    ...
    if has_logs:
        management_row.extend(
            [
                refresh_button,
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_CLEAR", "🗑️ Clear"), callback_data="admin_mon_clear_logs"
                ),
            ]
        )
    else:
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_BACK_TO_MONITORING", "⬅️ Back to monitoring"), callback_data="admin_monitoring"
            )
        ]
    )
...
def get_monitoring_status_keyboard(
    ...
    if is_running:
        control_row.extend(
            [
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_RESTART", "🔄 Restart"), callback_data="admin_mon_restart"
                ),
            ]
        )
    else:
        control_row.append(
            InlineKeyboardButton(text=_t(texts, "ADMIN_MONITORING_START", "▶️ Start"), callback_data="admin_mon_start")
        )
    ...
    if not is_running or last_check_ago_minutes > 10:
        monitoring_row.append(
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_MONITORING_FORCE_CHECK", "⚡ Urgent check"), callback_data="admin_mon_force_check"
            )
        )
    else:
        monitoring_row.append(
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_MONITORING_CHECK_NOW", "🔄 Check now"), callback_data="admin_mon_force_check"
            )
        )
...
def get_log_type_filter_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_MONITORING_ALL_LOGS", "📋 All logs"), callback_data="admin_mon_logs"
                ),
                InlineKeyboardButton(text=texts.BACK, callback_data="admin_monitoring"),
            ],
        ]
...
def get_admin_servers_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SERVERS_LIST", "📋 Server list"), callback_data="admin_servers_list"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SERVERS_SYNC", "🔄 Sync"), callback_data="admin_servers_sync"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SERVERS_ADD", "➕ Add server"), callback_data="admin_servers_add"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SERVERS_STATS", "📊 Statistics"), callback_data="admin_servers_stats"
                ),
            ],
...
def get_server_edit_keyboard(server_id: int, is_available: bool, language: str = "ru") -> InlineKeyboardMarkup:
    ...
    toggle_text = (
        _t(texts, "ADMIN_SERVER_DISABLE", "❌ Disable")
        if is_available
        else _t(texts, "ADMIN_SERVER_ENABLE", "✅ Enable")
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_SERVER_DELETE", "🗑️ Delete"), callback_data=f"admin_server_delete_{server_id}"
                ),
...
def get_maintenance_keyboard(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_MAINTENANCE_CHECK_API", "🔍 Check API"), callback_data="maintenance_check_api"
            ),
            InlineKeyboardButton(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(text=_t(texts, "ADMIN_REFRESH", "🔄 Refresh"), callback_data="maintenance_panel"),
            InlineKeyboardButton(text=texts.BACK, callback_data="admin_submenu_settings"),
        ]
    )
...
def get_welcome_text_keyboard(language: str = "ru", is_enabled: bool = True) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    toggle_text = (
        _t(texts, "ADMIN_WELCOME_DISABLE", "🔴 Disable")
        if is_enabled
        else _t(texts, "ADMIN_WELCOME_ENABLE", "🟢 Enable")
    )
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_WELCOME_EDIT", "📝 Edit text"), callback_data="edit_welcome_text"
            ),
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_WELCOME_SHOW", "👁️ Show current"), callback_data="show_welcome_text"
            ),
        ],
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_WELCOME_PREVIEW", "👁️ Preview"), callback_data="preview_welcome_text"
            ),
            InlineKeyboardButton(text=_t(texts, "ADMIN_WELCOME_RESET", "🔄 Reset"), callback_data="reset_welcome_text"),
        ],
        [
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_WELCOME_HTML", "🏷️ HTML formatting"), callback_data="show_formatting_help"
            ),
            InlineKeyboardButton(
                text=_t(texts, "ADMIN_WELCOME_PLACEHOLDERS", "💡 Placeholders"), callback_data="show_placeholders_help"
            ),
        ],
        [InlineKeyboardButton(text=texts.BACK, callback_data="admin_submenu_communications")],
    ]
...
def get_broadcast_media_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_ADD_PHOTO", "📷 Add photo"), callback_data="add_media_photo"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_ADD_VIDEO", "🎥 Add video"), callback_data="add_media_video"
                ),
            ],
            [
                InlineKeyboardButton(
                ...
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_SKIP_MEDIA", "⏭️ Skip media"), callback_data="skip_media"
                ),
            ],
...
def get_media_confirm_keyboard(language: str = "ru") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_USE_MEDIA", "✅ Use this media"), callback_data="confirm_media"
                ),
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_REPLACE_MEDIA", "🔄 Replace media"), callback_data="replace_media"
                ),
            ],
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_NO_MEDIA", "⏭️ No media"), callback_data="skip_media"
                ),
                InlineKeyboardButton(text=_t(texts, "ADMIN_CANCEL", "❌ Cancel"), callback_data="admin_messages"),
            ],
        ]
...
def get_updated_message_buttons_selector_keyboard_with_media(
    ...
    if has_media:
        keyboard.append(
            [
                InlineKeyboardButton(
                    text=_t(texts, "ADMIN_BROADCAST_CHANGE_MEDIA", "🖼️ Change media"), callback_data="change_media"
                )
            ]
        )
    ...
    keyboard.extend(
        [
            [InlineKeyboardButton(text=_t(texts, "ADMIN_CONTINUE", "✅ Continue"), callback_data="buttons_confirm")],
            [InlineKeyboardButton(text=_t(texts, "ADMIN_CANCEL", "❌ Cancel"), callback_data="admin_messages")],
        ]
    )
